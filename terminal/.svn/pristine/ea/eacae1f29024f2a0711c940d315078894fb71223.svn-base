 ...
 * 渠道客户常态化宽表
 */
public class ZdResultCustomerNormalM implements Serializable{

	private static final long serialVersionUID = 1L;

	  private String statMonth;   // 月份 YYYYMM
	  private String orgacode;     // 渠道客户编码
	  private String custname;     // 渠道客户名称
	  private String areaname;     // 地市
	  private String linkman;      // 联系人姓名
	  private String tel;          // 联系人电话
	  
	  private String cntstock;     // 存量用户数
	  private String cntdm;        // DM窜货量
	  private String kll;          // 客流量
	  private String cntmaybechg ; // 预计换机用户数
	...
	public String getCntdm() {
		return cntdm;
	}
	public void setCntdm(String cntdm) {
		this.cntdm = cntdm;
	}
