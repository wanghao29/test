			...
			<div class="row top-select">
				...
				<div class="col-xs-2">
					...
					<input name="month2" id="month2"  type="text"
						style="width:60%;text-align:center;" readonly="readonly"
				...
				<div class="col-xs-2" align="left">
					...
					<select id="abSet"
						name="abSet" class="select" style="width: 60%;text-align:center; float: left;" onclick="absoluteDate()">
								...
								<form id="uploadForm" enctype="multipart/form-data">
									<div class="modal-body" style="margin-left: 50px;">
										<input type="file" id="file" name="file"
											...
											<div style="margin-top:20px;margin-right: 200px;margin-bottom: 20px;">
											 <label>选择时间:</label> <input
											name="month" id="times" type="text" style="width: 30%"
											readonly="readonly" class="form-text select prevMonth"
											onClick="WdatePicker({dateFmt:'yyyyMM',maxDate:'%y-{%M-1}',onpicked:pageInit})" />
											<a style="color:white;" href="<%=basePath%>resources/tmpl/brand.xlsx">模板下载</a>
									      </div>
								</form>
