...
//		  		$("#list").jqGrid('setCell', rowid, iCol/cellname, '', 'not-editable-cell');
	        ...
	        colModel : [ {name : '23',index : '23',width:80,sorttype : "float",align:"center", fixed: true, sortable: false, resize: false,formatter: tiaohuan}, 
	        	         {name:'brandname', index:'brandname', width:"180%", editable: true},	//
	        	         {name:'spec', index:'SPEC', width:"180%", editable: true},                   
	                     {name : 'meterdes',index : 'METERDES',width:"180%",sorttype : "int", editable: true}, 
	                     {name : 'meter',index : 'METER',width:"180%",sorttype : "date", editable: true}, 
	                     {name : 'sname',index : 'SNAME',width:100,sorttype : "date", editable: true}, 
	                     {name : 'pm',index : 'PM',width:"180%",sorttype : "float", editable: true},
	                     {name:'pricelevle', index:'PRICELEVLE',width:"180%",  editable: true},
	                     {name : 'purprice',index : 'PURPRICE',width:"180%",sorttype : "float", editable: true}, 
	                     {name:'proxytype', index:'PROXYTYPE', width:"180%", editable: true},  
	                     {name:'copermodel', index:'COPERMODEL',width:"180%",  editable: true},  
	                     
	                     {name:'competbrandname1', index:'competbrandname1', width:140, editable: true}, 
	                     {name:'competspec1', index:'COMPETSPEC1',width:140, editable: true},  
	                     {name : 'competbrandname2',index : 'COMPETBRANDNAME2',width:140,sorttype : "float",editable: true},  
	                     {name : 'competspec2',index : 'COMPETSPEC2',width:140,editable: true,sorttype : "float"}, 
	                     {name : 'competbrandname3',index : 'COMPETBRANDNAME3',editable: true,width:140,sorttype : "float"}, 
	                     {name : 'competspec3',index : 'COMPETSPEC3',width:140,editable: true,sorttype : "float"}, 
	                     
	                     {name:'bibrandname1', index:'bibrandname1', width:140, editable: true}, 
	                     {name:'bispec1', index:'bispec1',width:140, editable: true},  
	                     {name : 'bibrandname2',index : 'bibrandname2',width:140,sorttype : "float",editable: true},  
	                     {name : 'bispec2',index : 'bispec2',width:140,editable: true,sorttype : "float"}, 
	                     {name : 'bibrandname3',index : 'bibrandname3',editable: true,width:140,sorttype : "float"}, 
	                     {name : 'bispec3',index : 'bispec3',width:140,editable: true,sorttype : "float"},
	                     
	                     {name : 'totalsaleamount',index : 'TOTAL_SALEAMOUNT',width:180,sorttype : "float"}, 
	                     {name : 'totalincome',index : 'TOTAL_INCOME',width:180,sorttype : "float"}, 
	                     {name : 'totalmaori',index : 'TOTAL_MAORI',width:180,sorttype : "float"}, 
	                     {name : 'totalshare',index : 'TOTAL_SHARE',width:"120%",sorttype : "float"}, 
	                     
	                     {name : 'totaloveramount',index : 'TOTAL_OVERAMOUNT',width:180,sorttype : "float"}, 
	                     {name : 'totalturnovertime',index : 'TOTAL_TURNOVER_TIME',width:"100%",sorttype : "float"}, 
