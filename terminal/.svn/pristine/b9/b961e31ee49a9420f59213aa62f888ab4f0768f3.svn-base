...
<div class="row row-height">
	<ul class="list-li-3 mt-20 clearfix">
		<li>
			<div class="box-head">
				<span class="title" style="width:245px;">终端公司覆盖客户数量</span>
			</div>		
		...
		<li>
			<div class="box-head">
				<span class="title" style="width:245px;">终端公司覆盖客户销量</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;">
		...
		<li>
			<div class="box-head">
				<span class="title" style="width:245px;">终端公司覆盖客户提货量</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;" >
...
<div class="row row-height">
	<ul class="list-li-3 mt-20 clearfix">
		<li>
			<div class="box-head">
				<span class="title" style="width:245px;" >终端公司客户覆盖网点数</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;">
		...
		<li>
			<div class="box-head">
				<span class="title" style="width:245px;">终端公司客户覆盖网点销量</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;">
		...
		<li>
			<div class="box-head">
				<span class="title" style="width:245px;">终端公司客户覆盖存量用户数</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;">
