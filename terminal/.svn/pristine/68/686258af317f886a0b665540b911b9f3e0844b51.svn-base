...
<table border="1" bordercolor="#1addfa" id="table5">
			...
			<tr>
                ...
                <td colspan="2" align="center">当前份额</td>
                <td rowspan="2" align="center">对标品份额</td>
                <td rowspan="2" align="center">竞品份额</td>
  ...
  <tr>	
				...
				<td>${list.nowSale}</td>
				<td>${list.weekSale}</td>
				<td>${list.benchSale}</td><!--对标品份额  -->
				<td>${list.competitorSale}</td><!--竞品份额  -->
