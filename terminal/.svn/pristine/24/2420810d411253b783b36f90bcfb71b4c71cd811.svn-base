...
<div class="row">
	<ol class="breadcrumb">
 	...
 	<div class="row" >
 		<div  class="col-xs-4"> 
 					<div class="box">
		                <div class="box-head"><span class="title" title="品牌覆盖门店数">品牌覆盖门店数</span></div>
 		...
 		<div  class="col-xs-8">
 					<div class="box">
		                <div class="box-head">
		                	<span class="title" style="width:120px">门店类型</span> 
		                ...
		                <div class="box-content" id="stockUser" style="border: 1px solid #4cb3c2!important;margin-top: 10px;">
		                      <ul id="myTab" class="nav nav-tabs nav-justified" style="margin-top: -5px;">
									<li class="active">
										<a href="" data-toggle="tab" class="type ttttTyp" value="T1" title="高价值门店">
											高价值门店
										</a>
									</li>
									<li><a href="" data-toggle="tab" class="type ttttTyp" value="T2" title="较高价值门店">较高价值门店</a></li>
									<li><a href="" data-toggle="tab" class="type ttttTyp" value="T3" title="偏高价值门店">偏高价值门店</a></li>
									<li><a href="" data-toggle="tab" class="type ttttTyp" value="T4" title="偏低价价值门店">偏低价价值门店</a></li>
									<li><a href="" data-toggle="tab" class="type ttttTyp" value="T5" title="较低价值门店">较低价值门店</a></li>
									<li><a href="" data-toggle="tab" class="type ttttTyp" value="T6" title="低价值门店">低价值门店</a></li>
								</ul>
								<div id="myTabContent" class="tab-content">
									<div class="tab-pane fade in active" id="">
										 
											<div class="col-xs-6">
												 <p style="color: #54abd6;margin-left: 10px;"><span style="background-color:#54abd6 ">|&nbsp;</span><label>门店覆盖占比</label></p>
											...
											<div class="col-xs-6">
												 <p style="color: #54abd6;margin-left: 10px;"><span style="background-color:#54abd6 ">|&nbsp;</span><label>门店覆盖客户数</label></p>
	...
	<div class="row" style="margin-top: 25px;">
 		<div  class="col-xs-4">
 					<div class="box">
		                <div class="box-head"><span class="title" title="品牌覆盖用户数">品牌覆盖用户数</span></div>
 		...
 		<div  class="col-xs-8">
 					<div class="box">
		                <div class="box-head">
		                	<span class="title" style="width:120px" title="">门店覆盖类型</span>
 ...
 <div  class="col-xs-4">
 					<div class="box">
		                <div class="box-head"><span class="title" title="品牌覆盖客商数">品牌覆盖客商数</span></div>
		                <div class="box-content"   style="border: 1px solid #4cb3c2!important;margin-top: 10px;" id="cover_num">
		                    <!--<img src="images/m21.png">-->
		                </div>
		            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="frame_type_all" style="">
		  ...
		  <div class="row" id="" >
				...
				<div class="col-xs-2"  >
				   	<p style="position:absolute;" class="absolute-div" >
		        		<select name="ttttTyp_termBrndNam" id="ttttTyp_termBrndNam" style="float:left;width: 96%;" class="select_searchable">
		        		</select>
	      			</p>
				</div>
				<div class="col-xs-2" style="">
				    <p>
					   	<select name="ttttTyp_type" class="select typeSelect" style="width: 100%;">
					   	    <option  value="0">存量门店</option>
	            			<option  value="1">新增门店</option>				            	
	       				</select>
	      			</p>
			    ...
			    <div class="col-xs-2" style=""> 
					<button type="button" 
						onclick="exportExcel('ttttTyp_list','门店覆盖情况-门店类型')" 
				    ...
				    <div class="panel-body" >
			        	<div  class="col-xs-12" id="">
				       		 <ul class="conditions_select" id="query_ttttTyp_fields_ul">
				       		    	...
				       		    	<li><label><input type="checkbox" value="hallCnt" class="type1_ttttTyp" checked />&nbsp;门店总数</label></li> 
				       		    	<li><label><input type="checkbox" value="num" class="type1_ttttTyp" checked />&nbsp;客户数</label></li> 
				       		    	<li><label><input type="checkbox" value="ttttTyp" class="type1_ttttTyp" checked />&nbsp;门店类型</label></li> 
				       		    	
				       		    	<li class="fieldGroup"><label><input type="checkbox" class="type2_ttttTyp_all" />&nbsp;覆盖占比：</label></li>	 
				       		    	<li><label><input type="checkbox" value="rete01" class="type2_ttttTyp" />&nbsp;高覆盖门店占比 </label></li>
				       		    	<li><label><input type="checkbox" value="rete03" class="type2_ttttTyp" />&nbsp;中高覆盖门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete05" class="type2_ttttTyp" />&nbsp;中覆盖门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete07" class="type2_ttttTyp" />&nbsp;中低覆盖门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete09" class="type2_ttttTyp" />&nbsp;低覆盖门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete11" class="type2_ttttTyp" />&nbsp;超低覆盖门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete13" class="type2_ttttTyp" />&nbsp;零覆盖门店占比</label></li>
				       		    	 
				       		    	<li class="fieldGroup"><label><input type="checkbox" class="type3_ttttTyp_all"/>&nbsp;覆盖客户数占比：</label></li>	 
				       		    	<li><label><input type="checkbox" value="rete02" class="type3_ttttTyp" />&nbsp;高覆盖门店覆盖客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete04" class="type3_ttttTyp" />&nbsp;中高覆盖门店覆盖客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete06" class="type3_ttttTyp" />&nbsp;中覆盖门店覆盖客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete08" class="type3_ttttTyp" />&nbsp;中低覆盖门店覆盖客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete10" class="type3_ttttTyp" />&nbsp;低覆盖门店覆盖客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete12" class="type3_ttttTyp" />&nbsp;超低覆盖门店覆盖客户数占比</label></li> 				       		    	 
				       		    	<li><label><input type="checkbox" value="rete14" class="type3_ttttTyp" />&nbsp;零覆盖门店覆盖客户数占比</label></li> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="frame_type_all" style="">
		  ...
		  <div class="row"  >
				...
				<div class="col-xs-2"  >
				   	<p style="position:absolute;" class="absolute-div" >
		        		<select name="brndFfffTyp_termBrndNam" id="brndFfffTyp_termBrndNam" style="float:left;width: 100%;" class="select_searchable">
		        		</select>
	      			</p>
				</div>
				<div class="col-xs-2" style="">
				    <p>
					   	<select name="brndFfffTyp_type" class="select typeSelect" style="width: 96%;">
					   	    <option  value="0">存量门店</option>
	            			<option  value="1">新增门店</option>				            	
	       				</select>
	      			</p>
			    ...
			    <div class="col-xs-2" style=""> 
					<button type="button" 
						onclick="exportExcel('brndFfffTyp_list','门店覆盖情况-门店覆盖类型')" 
						class="btn btn-primary" style="width:100%" > 导出EXCEL</button>
				</div>									
		  </div>      	        
			        	...
			        	<div  class="col-xs-12" id="query_conditions">
				       		 <ul class="conditions_select" id="query_brndFfffTyp_fields_ul">	    
				       		      <li class="fieldGroup"><label><input type="checkbox" class="type1_brndFfffTyp_all" checked/>&nbsp;基础信息：</label></li>	    
				       		    	...
				       		    	<li><label><input type="checkbox" value="hallCnt" class="type1_brndFfffTyp" checked />&nbsp;门店总数</label></li> 
				       		    	<li><label><input type="checkbox" value="num" class="type1_brndFfffTyp" checked />&nbsp;客户数</label></li> 
				       		    	<li><label><input type="checkbox" value="brndFfffTyp" class="type1_brndFfffTyp" checked />&nbsp;门店类型</label></li> 
				       		    	
				       		    	<li class="fieldGroup"><label><input type="checkbox" class="type2_brndFfffTyp_all" />&nbsp;门店占比：</label></li>	 
				       		    	<li><label><input type="checkbox" value="rete01" class="type2_brndFfffTyp" />&nbsp;T1门店占比</label></li>
				       		    	<li><label><input type="checkbox" value="rete03" class="type2_brndFfffTyp" />&nbsp;T2门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete05" class="type2_brndFfffTyp" />&nbsp;T3门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete07" class="type2_brndFfffTyp" />&nbsp;T4门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete09" class="type2_brndFfffTyp" />&nbsp;T5门店占比</label></li> 
				       		    	<li><label><input type="checkbox" value="rete11" class="type2_brndFfffTyp" />&nbsp;T6门店占比</label></li> 
				       		    	 
				       		    	<li class="fieldGroup"><label><input type="checkbox" class="type3_brndFfffTyp_all"/>&nbsp;门店客户数占比：</label></li>	 
				       		    	<li><label><input type="checkbox" value="rete02" class="type3_brndFfffTyp" />&nbsp;T1门店客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete04" class="type3_brndFfffTyp" />&nbsp;T1门店客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete06" class="type3_brndFfffTyp" />&nbsp;T1门店客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete08" class="type3_brndFfffTyp" />&nbsp;T1门店客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete10" class="type3_brndFfffTyp" />&nbsp;T1门店客户数占比</label></li> 				       		    	
				       		    	<li><label><input type="checkbox" value="rete12" class="type3_brndFfffTyp" />&nbsp;T1门店客户数占比</label></li> 			       		    		    
				       		 </ul> 
			        	</div>				       
				    </div>
			   </div>
...
$(document).ready(function() {	
	...
	$(".type").click(function(){
		...
		var areaname = $("select[name='cityNam']").val();
		var dodate = $("input[name='month']").val();
		var brandname = $("select[name='termBrndNam']").val();
		$.ajax({

		    url:  "${basePath}/dmDate/getCoverBrandSum.do",
		    type : "post",
			async : false,
			cache : false,
			dataType : "json",
		    ...
		    success: function(result){
		    	if(result.cnts.length==0){
		    		result.cnts=[0,0,0,0,0,0];		    		
		    	}
		    	showNumsCover(result.months,result.cnts);
		    	//brndFfff(result.brndFfff);
		        //brndTttt(result.brndTttt); 
		    }
		});
...
function ttttTyp_jqgridInit(){
    var colNames = ['地市','月份','品牌名称','类型(新增/存量)','门店总数','客户数','门店类型',
       		    	'高覆盖门店占比','中高覆盖门店占比','中覆盖门店占比','中低覆盖门店占比','低覆盖门店占比','超低覆盖门店占比','零覆盖门店占比',
       		    	'高覆盖门店覆盖客户数占比','中高覆盖门店覆盖客户数占比','中覆盖门店覆盖客户数占比',
       		    	'中低覆盖门店覆盖客户数占比','低覆盖门店覆盖客户数占比','超低覆盖门店覆盖客户数占比','零覆盖门店覆盖客户数占比'
               ];
    var colModel = [ 
                 ...
                 {name : 'hallCnt',index : 'hallCnt',sorttype : "int",searchoptions:{sopt:['eq','lt','le','gt','ge','ne','cn']}}, 
	...
	jqgrid_init("ttttTyp_list","ttttTyp_pager","${basePath}/shopCover/queryConditions.do",{},colNames,colModel,"termBrndNam");
};
...
function brndFfffTyp_jqgridInit(){
    var colNames2 = ['地市','月份','品牌名称','类型(新增/存量)','门店总数','客户数','门店类型',
       		    	'T1门店占比','T2门店占比','T3门店占比','T4门店占比','T5门店占比','T6门店占比',
       		    	'T1门店客户数占比','T2门店客户数占比','T3门店客户数占比','T4门店客户数占比','T5门店客户数占比','T6门店客户数占比'
               ];
    var colModel2 = [ 
                 {name : 'cityNam',index : 'cityNam',sorttype : "string",searchoptions:{sopt:['eq','lt','le','gt','ge','ne','cn']}}, 
                 {name : 'month',index : 'month',sorttype : "string",searchoptions:{sopt:['eq','lt','le','gt','ge','ne','cn']}}, 
	...
	jqgrid_init("brndFfffTyp_list","brndFfffTyp_pager","${basePath}/shopCover/queryConditions.do",{},colNames2,colModel2,"termBrndNam");
};
...
function brndFfffTyp_list_setGroupHeaders(){
	  ...
	  jQuery("#brndFfffTyp_list").jqGrid('setGroupHeaders', {
		    ...
		    groupHeaders:[
		    {startColumnName: 'cityNam', numberOfColumns: 7, titleText: '基础信息'},
		    {startColumnName: 'rete01', numberOfColumns: 6, titleText: '门店占比'},
		    {startColumnName: 'rete02', numberOfColumns: 6, titleText: '门店客户数占比'},
		    ]  
	  });
}
...
function ttttTyp_getbrands(){
	...
	$.ajax({
	    type: "post",
	    url:  "${basePath}/shopCover/getBrands.do",
	    contentType: 'application/json',
	    data: JSON.stringify(data),
	    dataType: "json",
	    async: true,
