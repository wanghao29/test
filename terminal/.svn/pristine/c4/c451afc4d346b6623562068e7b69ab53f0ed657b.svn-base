...
<table border="1" bordercolor="#1addfa" id="table5">
			...
			<tr>
                ...
                <td colspan="2" class="nowXL" align="center">当前收入</td>
                <td rowspan="2" class="DBamount" align="center">对标品收入</td>
                <td rowspan="2" class="JPamount" align="center">竞品收入</td>
                <td colspan="3" class="lifeZQ" align="center">销量规划健康性</td>
			...
			<tr>			
				...
				<td class="nowXL">累计收入</td>
				<td class="nowXL">本周收入</td>
