 ...
 <%--        <ul>
          ...
          <div class="options"> 
               <ul class="nav navbar-nav navbar-right">
			         ...
			         <li > <a href="#"  style=" height: 38px;"class="user-head" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" > 
        ...
        <div class="clearfix">
            <ul class="index-wrap module-one" style="list-style: none;">
                ...
                <li>
                	 ...
                	 <a id="data_monitor"    href="<%=basePath%>entry/newIndex.do?special=MONITOR"     style="color: #00FFFF;">
