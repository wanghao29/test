...
<script src="<%=basePath%>resources/js/brandRangeSet/bootstrap-select.js?"></script>
 ...
 <label style="background-color: #00063c;font-size: 18px;margin-left:19%"> 关注维度：</label>  
   ...
   <a download="价数据导出Excel" id="excelOut" class="bt5" href="#" style="height: 50px;margin-left:70%">导出Excel</a>
   </div>
   </div>
...
<table border="1" bordercolor="#1addfa" id="table5">
			...
			<!-- 	<td rowspan="2">品牌</td>
                ...
                <td rowspan="2" class="healthLife">本品价格</td>
				<td  rowspan="2" class="healthLife">本品二级市场价格</td>
				<td  rowspan="2" class="healthLife">竞品二级市场价格</td>
