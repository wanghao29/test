...
//    setAutoMonth();
    ...
    $("input[name='endMonth']").val('201812');
     ...
     $.ajax({
		   type: 'post',
		   url: basePath+'/businessIncome/privateBrandIncome/getEchartData.do',
        ...
        loadTable('#grid',
            basePath + "/businessIncome/privateBrandIncome/list.do",
...
//            console.log($(field[0]));
        ...
        onEditableSave: function (field, row, oldValue, $el) {
            if(field == 'mbz'){
                $.ajax({
                    type: "post",
                    url: basePath + "/businessIncome/privateBrandIncome/updateByTargetVal.do",
                    contentType: "application/json; charset=utf-8",
                ...
                $.ajax({
                    type: "post",
                    url: basePath + "/businessIncome/privateBrandIncome/update.do",
                    contentType: "application/json; charset=utf-8",
