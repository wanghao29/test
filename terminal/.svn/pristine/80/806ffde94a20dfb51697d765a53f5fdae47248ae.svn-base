...
<body style="overflow-x:hidden;min-width: 1508px;">
    ...
    <script type="text/javascript" src="<%=basePath%>resources/js/cityKpi/model_internetIncome.js?"></script> 
	...
	<span style="color: #33ffff;font-size: 20px;">经分监控   / 收 / 互联网收入</span>
	</div>
	</div>
...
var url="../InternetCome/takeBrand.do";
...
function getOneBrand(){
	...
	var brand = $("#selectBrand").val();   //大类名称 	selectBrand
	 //document.getElementById("portname3").value =brand;		
		...
		var obj="";		
		var pp=	$("#model_DURATION2").val();
        var url="../InternetCome/takeSpec.do";
...
function getOneSpec(){
	...
	//document.getElementById("portname3").value =brand;		
		...
		var obj="";		
		var pp=	$("#model_DURATION2").val();
        var url="../InternetCome/takePZ.do";
...
function selectAllPZ(){
	...
	//var spec = params.name;   //大类名称 	
	 //document.getElementById("portname4").value =spec;		
		...
		var obj="";		
		var pp=	$("#model_DURATION2").val();
        var url="../InternetCome/takeColor.do";
...
function selectOnColor(){
	...
	var color=$("#selectColor").val();
	 //document.getElementById("portname6").value =color;	 
		var obj="";		
		var pp=	$("#model_DURATION2").val();
        var url="../InternetCome/takeQD.do";
