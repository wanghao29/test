...
<title>自有品牌其他多形态终端收入</title>
</head>

<body>
 
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/operateIncome/ownBrandOtherMultiIncome.js"></script>
	<style type="text/css">
	table tr td{
	  margin-right: 10px;
	}
	...
	.ui-jqgrid .ui-common-table {
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="自有品牌其他多形态终端收入_19"/><!-- 标记所属的指标 -->
	     <input type="hidden" id="billcyc"  value="${billcyc}"/>
	<div class="row">
		<ol class="breadcrumb">
		 <li>经分监控 </li>
		  <li>基础项 </li>
		  <li class=" ">自有品牌其他多形态终端收入</li>
		</ol>
	</div>
		  ...
		  <div class="panel panel-default" style=" width: 100%;">
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				    ...
				    <div class="col-xs-4" style="float:right;">
				    	...
				    	<input type="hidden" id="hid_kpikey" value="ownBrandOtherMultiIncome"/><!-- 和权限有关  慎改 -->
				    </div>
