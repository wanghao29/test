...
<div class="row row-height">
	<ul class="list-li-3 mt-20 clearfix">
		<li>
			<div class="box-head">
				<span class="title" style="width:200px;">广东移动覆盖门店数量</span>
			</div>		
		...
		<li>
			<div class="box-head">
				<span class="title" style="width:200px;">广东移动覆盖门店销量</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;">
 		...
 		<li>
			<div class="box-head">
				<span class="title" style="width:200px;">存量客户数</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;" >
...
<div class="row row-height">
	<ul class="list-li-3 mt-20 clearfix">
		<li>
			<div class="box-head">
				<span class="title" style="width:200px;">终端公司覆盖门店数量</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;">
		...
		<li>
			<div class="box-head">
				<span class="title" style="width:200px;">终端公司覆盖门店销量</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;">
		...
		<li>
			<div class="box-head">
				<span class="title" style="width:200px;" >客流量</span>
			</div>		
			<div class="box" style="border: 1px solid #558baf!important;">
