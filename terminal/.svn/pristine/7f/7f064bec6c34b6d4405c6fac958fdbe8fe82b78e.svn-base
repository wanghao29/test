...
function jqgridInit(){
	  jQuery("#grid").jqGrid(
	      {
	        url:basePath+"/ownBrandMultiIncome/queryData.do",
	        mtype:'post',
	        datatype: "json",
	        ...
	        //scroll:1, 滚动加载
	        //datatype : "local",
	        colNames : [ '月份','收入','收入调整','全年完成收入','目标值','时间完成度','全年完成度','本月收入完成率','分值'  ],
	        colModel : [ 
	           {name : 'billcyc',index : 'billcyc' }, 
			   {name : 'sr',index : 'sr', formatter: "number", formatoptions: {thousandsSeparator:",", defaulValue:"",decimalPlaces:2}  }, 
               {name : 'srtz',index : 'srtz' ,hidden:true, formatter: "number", formatoptions: {thousandsSeparator:",", defaulValue:"",decimalPlaces:2} }, 
               {name : 'qnwcsr',index : 'qnwcsr' , formatter: "number", formatoptions: {thousandsSeparator:",", defaulValue:"",decimalPlaces:2} }, 
			   {name : 'mbz',index : 'mbz' , formatter: "number", formatoptions: {thousandsSeparator:",", defaulValue:"",decimalPlaces:2}}, 
               {name : 'sjwcd',index : 'sjwcd',formatter:function(cellvalue, options, rowObject){ return cellvalue+"%" ; }}, 
               {name : 'qnwcd',index : 'qnwcd',hidden:true,formatter:function(cellvalue, options, rowObject){ return cellvalue+"%"; } }, 
