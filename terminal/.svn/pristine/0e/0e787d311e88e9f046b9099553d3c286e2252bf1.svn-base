 ...
 * 厅店维度  各覆盖程度中厅店类型统计表 
 */
public class HallBrndTttt implements Serializable{
	...
	private String rete01;       //T1  基站占比
	private String rete02;       //T1基站客户数占比
	private String rete03;       //T2  基站占比
	private String rete04;       //T2基站客户数占比
	private String rete05;       //T3  基站占比
	private String rete06;       //T3基站客户数占比
	private String rete07;       //T4  基站占比
	private String rete08;       //T4基站客户数占比
	private String rete09;       //T5  基站占比
	private String rete10;       //T5基站客户数占比
	private String rete11;       //T6  基站占比
	private String rete12;       //T6基站客户数占比
