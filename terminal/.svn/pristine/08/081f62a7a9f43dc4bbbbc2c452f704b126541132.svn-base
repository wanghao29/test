	...
	<script src="<%=basePath%>resources/js/brandRangeSet/full-min.js?"></script>
		...
		<div class="row" style="padding-top: 30px;">
				...
				<div class="col-xs-2" align="left">
					<span >— &nbsp;&nbsp;</span>
					<input name="month2" id="month2"  type="text" style="width:60%"
						 readonly="readonly"
					...
					<div class="col-xs-2" align="left">
					<span >数值类型:&nbsp;&nbsp;&nbsp;</span> 
					<select id="abSet" name="abSet" class="select" onclick="absoluteDate()">
							...
							<div class="modal-content">
								...
								<form id="uploadForm" enctype="multipart/form-data">
									<div class="modal-body">
										...
										<input name="month" type="text" style="width: 60%"
											readonly="readonly" class="form-text select prevMonth"
