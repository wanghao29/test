...
$.extend({
	StandardPost : function(url, args) {
		var form = $("<form method='get'></form>"), input;
		form.attr({
			"action" : url
		});
		form.attr({
...
//互联网销量
function internet_model() { 
	//var timed = $("#times").val();//时间类型		

	$.StandardPost(basePath + '/modelInternet/index.do', {
...
//互联网收入
function internet_income(){
	
$.StandardPost(basePath + '/InternetCome/index.do', {
...
//互联网毛利
function internet_rote(){
	
	
$.StandardPost(basePath + '/InternetRote/index.do', {
...
function chooseTakeDate(){
	
	
	$.StandardPost(basePath + '/modelInternet/indexin.do', {
