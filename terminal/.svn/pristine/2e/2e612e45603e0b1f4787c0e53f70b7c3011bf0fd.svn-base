			 	...
			 	<div class="col-xs-1">
			  				  ...
			  				  <!--     	<label>地市:</label>    -->
				 	 				   	<select name="tag1" class="select" style="width: 100%;" id="citySelect">
				 	 				   		      		<shiro:hasPermission name="QS"><option value="" selected="selected">全省</option></shiro:hasPermission> 
				 	 				   		       		<shiro:hasPermission name="GZ"><option value="GZ" >广州</option></shiro:hasPermission>
								...
								<!-- 	<label>换机前终端型号：</label>
									...
									<label>主套餐价格：</label>
									<select class="select" id="pkgDtlFeeAmtMin" style="width: 100px;">
									</select>
									<label>~</label>
									<select class="select" id="pkgDtlFeeAmtMax" style="width: 100px;">
									</select>
									&nbsp;&nbsp;
									<label>账期：</label>
									<input id="billcyc" class="form-text select startDay" name="datetime" type="text" style="width:100px" onClick="WdatePicker({dateFmt:'yyyyMM'})" readonly="readonly"class="form-text"/>
			 	 					&nbsp;&nbsp;
			 	 					 	<a href="#Detailed"  style=" float: right;"><button type="button" id="searchBtn"  class="btn btn-primary" style="width:100px"> 查询</button></a>
								</div>
								<br/>
					      	...
					      	<tr>
		                       ...
		                       <!--    <input id="checkbox2" class="styled"  name="basic_feature" type="checkbox" value="brndCd" checked>
		                          ...
		                          <label for="checkbox2">AOU分层</label>
		               		     ...
		               		     <div class="checkbox checkbox-primary">
		                          <input id="checkbox2" class="styled" name="switch_features" type="checkbox" value="pkgDtlFeeAmt" >
		                          <label for="checkbox2">主套餐价格</label>
		               		     </div>
		               		   </td>
		               		   <td>
					      	     <div class="checkbox checkbox-primary">
		               		...
		               		<!--       <div class="checkbox checkbox-primary">
		                          ...
		                          <label for="checkbox2">当前终端产品型号</label>
		               		      ...
		               		      <div class="checkbox checkbox-primary">
		                          <input id="checkbox2" class="styled"  name="factory_information"   type="checkbox" value="lmBrand" >
		                          <label for="checkbox2">换机前的终端品牌</label>
		               		     </div>
		               		      <div class="checkbox checkbox-primary">
		                          <input id="checkbox2" class="styled"  name="factory_information"   type="checkbox" value="lmTerType" >
		                          <label for="checkbox2">换机前的终端型号</label>
		               		     </div>
		               		       <div class="checkbox checkbox-primary">
		                          <input id="checkbox2" class="styled"  name="factory_information"   type="checkbox" value="innetUsrCnt" >
		                          <label for="checkbox2">在网用户数</label>
		               		     </div>
					      	  ...
					      	  <div class="checkbox checkbox-primary">
		                          <input id="checkbox2" class="styled"  name="machine_type" type="checkbox" value="newTermInd" >
		                          <label for="checkbox2">是否当月新增终端</label>
		               		     </div>
		               		     <div class="checkbox checkbox-primary">
		                          <input id="checkbox2" class="styled"  name="machine_type" type="checkbox" value="newUsrInd" >
		                          <label for="checkbox2">是否当月新入网用户</label>
		               		     </div>
					      	  </td>
					      	  <td>
					      	  	 <div class="checkbox checkbox-primary">
