...
function selelctAll(){
	...
	if(timeKind=="1"){
		...
		//var kind="2";
		//$.StandardPost(basePath+'/InternetCome/deleteModel.do',{'lsltype':lsltype,'datetype':datetype,'datevalue':datevalue ,'endMonth':endMonth,'kind':kind});
	
		 $.ajax({  
		        type: "post",  
		        url: "../InternetCome/deleteModel.do",  
...
function jqgridInit(){
	  jQuery("#list").jqGrid(
	      {
	        //datatype : "local",
	        url:basePath+'/InternetCome/selectProductList.do',
	        mtype:'post',
	        datatype: "json",
	        loadonce:true,     //一次性加载
