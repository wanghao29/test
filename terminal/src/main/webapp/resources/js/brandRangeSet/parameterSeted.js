...
{
   //对汇总的周数进行赋值
	var weekOne = parseFloat(document.getElementById('DURATION1').value);
	if(isNaN(weekOne)){
		weekOne=0;
		 }
   var weekTwo = parseFloat(document.getElementById('DURATION2').value);
   if(isNaN(weekTwo)){
	   weekTwo=0;
		 }
   var weekThree = parseFloat(document.getElementById('DURATION3').value);
   if(isNaN(weekThree)){
	   weekThree=0;
		 }
   var weekFour = parseFloat(document.getElementById('DURATION4').value);
   if(isNaN(weekFour)){
	   weekFour=0;
		 }
   var weekTotal='';
    weekTotal=weekOne+weekTwo+weekThree+weekFour;
    var weekTotal1= weekTotal.toFixed(1);
    document.getElementById('weekSum').innerHTML=weekTotal1;
  //对汇总的销量进行赋值
    var saleOne = parseFloat(document.getElementById('SALEAMOUNT1').value);
    if(isNaN(saleOne)){
    	saleOne=0;
		 }
  var saleTwo = parseFloat(document.getElementById('SALEAMOUNT2').value);
  if(isNaN(saleTwo)){
	  saleTwo=0;
		 }
  var saleThree = parseFloat(document.getElementById('SALEAMOUNT3').value);
  if(isNaN(saleThree)){
	  saleThree=0;
		 }
  var saleFour = parseFloat(document.getElementById('SALEAMOUNT4').value);
  if(isNaN(saleFour)){
	  saleFour=0;
		 }
  var saleTotal='';
    saleTotal=saleOne+saleTwo+saleThree+saleFour;
    var saleTotal1= saleTotal.toFixed(1);
    document.getElementById('saleAmount').innerHTML=saleTotal1;
    document.getElementById('actualSaleAmount').innerHTML=saleTotal1;
  //对汇总的收入进行赋值
    var incomeOne = parseFloat(document.getElementById('INCOME1').value);
    if(isNaN(incomeOne)){
    	incomeOne=0;
		 }
  var incomeTwo = parseFloat(document.getElementById('INCOME2').value);
  if(isNaN(incomeTwo)){
	  incomeTwo=0;
		 }
  var incomeThree = parseFloat(document.getElementById('INCOME3').value);
  if(isNaN(incomeThree)){
	  incomeThree=0;
		 }
  var incomeFour = parseFloat(document.getElementById('INCOME4').value);
  if(isNaN(incomeFour)){
	  incomeFour=0;
		 }
  var incomeTotal='';
    incomeTotal=incomeOne+incomeTwo+incomeThree+incomeFour;
    var incomeTotal1= incomeTotal.toFixed(1);
    document.getElementById('incomeAmount').innerHTML=incomeTotal1;
    document.getElementById('actualIncomeAmount').innerHTML=incomeTotal1;
  //对汇总的利润总量进行赋值
    var profitOne = parseFloat(document.getElementById('MAORI1').value);
    if(isNaN(profitOne)){
    	profitOne=0;
		 }
  var profitTwo = parseFloat(document.getElementById('MAORI2').value);
  if(isNaN(profitTwo)){
	  profitTwo=0;
		 }
  var profitThree = parseFloat(document.getElementById('MAORI3').value);
  if(isNaN(profitThree)){
	  profitThree=0;
		 }
  var profitFour = parseFloat(document.getElementById('MAORI4').value);
  if(isNaN(profitFour)){
	  profitFour=0;
		 }
  var profitTotal='';
    profitTotal=profitOne+profitTwo+profitThree+profitFour;
    var profitTotal1= profitTotal.toFixed(1);
    document.getElementById('profitAmount').innerHTML=profitTotal1;
  //对汇总的覆盖进行赋值
    var stockOne = parseFloat(document.getElementById('OVERAMOUNT1').value);
    if(isNaN(stockOne)){
    	stockOne=0;
		 }
  var stockTwo = parseFloat(document.getElementById('OVERAMOUNT2').value);
  if(isNaN(stockTwo)){
	  stockTwo=0;
		 }
  var stockThree = parseFloat(document.getElementById('OVERAMOUNT3').value);
  if(isNaN(stockThree)){
	  stockThree=0;
		 }
  var stockFour = parseFloat(document.getElementById('OVERAMOUNT4').value);
  if(isNaN(stockFour)){
	  stockFour=0;
		 }
  var stockTotal='';
    stockTotal=stockOne+stockTwo+stockThree+stockFour;
    var stockTotal1= stockTotal.toFixed(1);
    document.getElementById('stockAmount').innerHTML=stockTotal1;
    document.getElementById('actualOverAmount').innerHTML=stockTotal1;
  //对汇总的份额进行赋值
    var shareOne = parseFloat(document.getElementById('SHARE1').value);
    if(isNaN(shareOne)){
    	shareOne=0;
		 }
  var shareTwo = parseFloat(document.getElementById('SHARE2').value);
  if(isNaN(shareTwo)){
	  shareTwo=0;
		 }
  var shareThree = parseFloat(document.getElementById('SHARE3').value);
  if(isNaN(shareThree)){
	  shareThree=0;
		 }
  var shareFour = parseFloat(document.getElementById('SHARE4').value);
  if(isNaN(shareFour)){
	  shareFour=0;
		 }
  var shareTotal='';
    shareTotal=shareOne+shareTwo+shareThree+shareFour;
    var shareTotal1= shareTotal.toFixed(1);
    document.getElementById('shareAmount').innerHTML=shareTotal1;
  //对汇总的覆盖量尽心赋值
    var overOne = parseFloat(document.getElementById('TURNOVERTIME1').value);
    if(isNaN(overOne)){
    	overOne=0;
		 }
  var overTwo = parseFloat(document.getElementById('TURNOVERTIME2').value);
  if(isNaN(overTwo)){
	  overTwo=0;
		 }
  var overThree = parseFloat(document.getElementById('TURNOVERTIME3').value);
  if(isNaN(overThree)){
	  overThree=0;
		 }
  var overFour = parseFloat(document.getElementById('TURNOVERTIME4').value);
  if(isNaN(overFour)){
	  overFour=0;
		 }
    var overTotal='';
    overTotal=overOne+overTwo+overThree+overFour;
    var tt= overTotal.toFixed(1);
    document.getElementById('overAmount').innerHTML=tt;
   // document.getElementById('actualOverAmount').innerHTML=overTotal;
  /************************对城市维度规划设置的值进行汇总 ***********************/
        
  //获取销量的汇总统计
	var areaSale1 = parseFloat(document.getElementById('areaSALEAMOUNT1').value); 
   if(isNaN(areaSale1)){
	  areaSale1=0;
	 }
    
	 var areaSale2 = parseFloat(document.getElementById('areaSALEAMOUNT2').value);
	 if(isNaN(areaSale2)){
		 areaSale2=0;
		 }
	 var areaSale3 = parseFloat(document.getElementById('areaSALEAMOUNT3').value);
	 if(isNaN(areaSale3)){
		 areaSale3=0;
		 }
	 var areaSale4 = parseFloat(document.getElementById('areaSALEAMOUNT4').value);
	 if(isNaN(areaSale4)){
		 areaSale4=0;
		 }
	 var areaSale5 = parseFloat(document.getElementById('areaSALEAMOUNT5').value);
	 if(isNaN(areaSale5)){
		 areaSale5=0;
		 }
	 var areaSale6 = parseFloat(document.getElementById('areaSALEAMOUNT6').value);
	 if(isNaN(areaSale6)){
		 areaSale6=0;
		 }
	 var areaSale7 = parseFloat(document.getElementById('areaSALEAMOUNT7').value);
	 if(isNaN(areaSale7)){
		 areaSale7=0;
		 }
	 var areaSale8 = parseFloat(document.getElementById('areaSALEAMOUNT8').value);
	 if(isNaN(areaSale8)){
		 areaSale8=0;
		 }
	 var areaSale9 = parseFloat(document.getElementById('areaSALEAMOUNT9').value);
	 if(isNaN(areaSale9)){
		 areaSale9=0;
		 }
	 var areaSale10 = parseFloat(document.getElementById('areaSALEAMOUNT10').value);
	 if(isNaN(areaSale10)){
		 areaSale10=0;
		 }
	 var areaSale11 = parseFloat(document.getElementById('areaSALEAMOUNT11').value);
	 if(isNaN(areaSale11)){
		 areaSale11=0;
		 }
	 var areaSale12 = parseFloat(document.getElementById('areaSALEAMOUNT12').value);
	 if(isNaN(areaSale12)){
		 areaSale12=0;
		 }
	 var areaSale13 = parseFloat(document.getElementById('areaSALEAMOUNT13').value);
	 if(isNaN(areaSale13)){
		 areaSale13=0;
		 }
	 var areaSale14 = parseFloat(document.getElementById('areaSALEAMOUNT14').value);
	 if(isNaN(areaSale14)){
		 areaSale14=0;
		 }
	 var areaSale15 = parseFloat(document.getElementById('areaSALEAMOUNT15').value);
	 if(isNaN(areaSale15)){
		 areaSale15=0;
		 }
	 var areaSale16 = parseFloat(document.getElementById('areaSALEAMOUNT16').value);
	 if(isNaN(areaSale16)){
		 areaSale16=0;
		 }
	 var areaSale17 = parseFloat(document.getElementById('areaSALEAMOUNT17').value);
	 if(isNaN(areaSale17)){
		 areaSale17=0;
		 }
	 var areaSale18 = parseFloat(document.getElementById('areaSALEAMOUNT18').value);
	 if(isNaN(areaSale18)){
		 areaSale18=0;
		 }
	 var areaSale19 = parseFloat(document.getElementById('areaSALEAMOUNT19').value);
	 if(isNaN(areaSale19)){
		 areaSale19=0;
		 }
	 var areaSale20 = parseFloat(document.getElementById('areaSALEAMOUNT20').value);
	 if(isNaN(areaSale20)){
		 areaSale20=0;
		 }
	 var areaSale21 = parseFloat(document.getElementById('areaSALEAMOUNT21').value);
	 if(isNaN(areaSale21)){
		 areaSale21=0;
		 }
	 var areaSale22 = parseFloat(document.getElementById('areaSALEAMOUNT22').value);
	 if(isNaN(areaSale22)){
		 areaSale22=0;
		 }
	 var areaSaleSum="";
     ...
     +areaSale16+areaSale17+areaSale18+areaSale19+areaSale20+areaSale21+areaSale22;
     var areaSaleSum1= areaSaleSum.toFixed(1);
     document.getElementById('saleAreaAmount').innerHTML=areaSaleSum1;
     document.getElementById('nowSaleAmount').innerHTML=areaSaleSum1;
 // 地市维度规划收入值设置计算总量
 

 
     var areaINCOME1 = parseFloat(document.getElementById('areaINCOME1').value); 
     if(isNaN(areaINCOME1)){
    	 areaINCOME1=0;
  	 }
      
  	 var areaINCOME2 = parseFloat(document.getElementById('areaINCOME2').value);
  	 if(isNaN(areaINCOME2)){
  		areaINCOME2=0;
  		 }
  	 var areaINCOME3 = parseFloat(document.getElementById('areaINCOME3').value);
  	 if(isNaN(areaINCOME3)){
  		areaINCOME3=0;
  		 }
  	 var areaINCOME4 = parseFloat(document.getElementById('areaINCOME4').value);
  	 if(isNaN(areaINCOME4)){
  		areaINCOME4=0;
  		 }
  	 var areaINCOME5 = parseFloat(document.getElementById('areaINCOME5').value);
  	 if(isNaN(areaINCOME5)){
  		areaINCOME5=0;
  		 }
  	 var areaINCOME6 = parseFloat(document.getElementById('areaINCOME6').value);
  	 if(isNaN(areaINCOME6)){
  		areaINCOME6=0;
  		 }
  	 var areaINCOME7 = parseFloat(document.getElementById('areaINCOME7').value);
  	 if(isNaN(areaINCOME7)){
  		areaINCOME7=0;
  		 }
  	 var areaINCOME8 = parseFloat(document.getElementById('areaINCOME8').value);
  	 if(isNaN(areaINCOME8)){
  		areaINCOME8=0;
  		 }
  	 var areaINCOME9 = parseFloat(document.getElementById('areaINCOME9').value);
  	 if(isNaN(areaINCOME9)){
  		areaINCOME9=0;
  		 }
  	 var areaINCOME10 = parseFloat(document.getElementById('areaINCOME10').value);
  	 if(isNaN(areaINCOME10)){
  		areaINCOME10=0;
  		 }
  	 var areaINCOME11 = parseFloat(document.getElementById('areaINCOME11').value);
  	 if(isNaN(areaINCOME11)){
  		areaINCOME11=0;
  		 }
  	 var areaINCOME12 = parseFloat(document.getElementById('areaINCOME12').value);
  	 if(isNaN(areaINCOME12)){
  		areaINCOME12=0;
  		 }
  	 var areaINCOME13 = parseFloat(document.getElementById('areaINCOME13').value);
  	 if(isNaN(areaINCOME13)){
  		areaINCOME13=0;
  		 }
  	 var areaINCOME14 = parseFloat(document.getElementById('areaINCOME14').value);
  	 if(isNaN(areaINCOME14)){
  		areaINCOME14=0;
  		 }
  	 var areaINCOME15 = parseFloat(document.getElementById('areaINCOME15').value);
  	 if(isNaN(areaINCOME15)){
  		areaINCOME15=0;
  		 }
  	 var areaINCOME16 = parseFloat(document.getElementById('areaINCOME16').value);
  	 if(isNaN(areaINCOME16)){
  		areaINCOME16=0;
  		 }
  	 var areaINCOME17 = parseFloat(document.getElementById('areaINCOME17').value);
  	 if(isNaN(areaINCOME17)){
  		areaINCOME17=0;
  		 }
  	 var areaINCOME18 = parseFloat(document.getElementById('areaINCOME18').value);
  	 if(isNaN(areaINCOME18)){
  		areaINCOME18=0;
  		 }
  	 var areaINCOME19 = parseFloat(document.getElementById('areaINCOME19').value);
  	 if(isNaN(areaINCOME19)){
  		areaINCOME19=0;
  		 }
  	 var areaINCOME20 = parseFloat(document.getElementById('areaINCOME20').value);
  	 if(isNaN(areaINCOME20)){
  		areaINCOME20=0;
  		 }
  	 var areaINCOME21 = parseFloat(document.getElementById('areaINCOME21').value);
  	 if(isNaN(areaINCOME21)){
  		areaINCOME21=0;
  		 }
  	 var areaINCOME22 = parseFloat(document.getElementById('areaINCOME22').value);
  	 if(isNaN(areaINCOME22)){
  		areaINCOME22=0;
  		 }
  	 var areaIncomeSum="";
  	areaIncomeSum=areaINCOME1+areaINCOME2+areaINCOME3+areaINCOME4+areaINCOME5+areaINCOME6+areaINCOME7
       ...
       +areaINCOME16+areaINCOME17+areaINCOME18+areaINCOME19+areaINCOME20+areaINCOME21+areaINCOME22;
  	var areaIncomeSum1= areaIncomeSum.toFixed(1);
       document.getElementById('areaIncomeAmount').innerHTML=areaIncomeSum1;
       document.getElementById('nowIncomeAomount').innerHTML=areaIncomeSum1;
 //覆盖客户数设置汇总值计算



var areaOVERAMOUNT1 = parseFloat(document.getElementById('areaOVERAMOUNT1').value); 
if(isNaN(areaOVERAMOUNT1)){
	areaOVERAMOUNT1=0;
}

var areaOVERAMOUNT2 = parseFloat(document.getElementById('areaOVERAMOUNT2').value);
if(isNaN(areaOVERAMOUNT2)){
	areaOVERAMOUNT2=0;
}
var areaOVERAMOUNT3 = parseFloat(document.getElementById('areaOVERAMOUNT3').value);
if(isNaN(areaOVERAMOUNT3)){
	areaOVERAMOUNT3=0;
}
var areaOVERAMOUNT4 = parseFloat(document.getElementById('areaOVERAMOUNT4').value);
if(isNaN(areaOVERAMOUNT4)){
	areaOVERAMOUNT4=0;
}
var areaOVERAMOUNT5 = parseFloat(document.getElementById('areaOVERAMOUNT5').value);
if(isNaN(areaOVERAMOUNT5)){
	areaOVERAMOUNT5=0;
}
var areaOVERAMOUNT6 = parseFloat(document.getElementById('areaOVERAMOUNT6').value);
if(isNaN(areaOVERAMOUNT6)){
	areaOVERAMOUNT6=0;
}
var areaOVERAMOUNT7 = parseFloat(document.getElementById('areaOVERAMOUNT7').value);
if(isNaN(areaOVERAMOUNT7)){
	areaOVERAMOUNT7=0;
}
var areaOVERAMOUNT8 = parseFloat(document.getElementById('areaOVERAMOUNT8').value);
if(isNaN(areaOVERAMOUNT8)){
	areaOVERAMOUNT8=0;
}
var areaOVERAMOUNT9 = parseFloat(document.getElementById('areaOVERAMOUNT9').value);
if(isNaN(areaOVERAMOUNT9)){
	areaOVERAMOUNT9=0;
}
var areaOVERAMOUNT10 = parseFloat(document.getElementById('areaOVERAMOUNT10').value);
if(isNaN(areaOVERAMOUNT10)){
	areaOVERAMOUNT10=0;
}
var areaOVERAMOUNT11 = parseFloat(document.getElementById('areaOVERAMOUNT11').value);
if(isNaN(areaOVERAMOUNT11)){
	areaOVERAMOUNT11=0;
}
var areaOVERAMOUNT12 = parseFloat(document.getElementById('areaOVERAMOUNT12').value);
if(isNaN(areaOVERAMOUNT12)){
	areaOVERAMOUNT12=0;
}
var areaOVERAMOUNT13 = parseFloat(document.getElementById('areaOVERAMOUNT13').value);
if(isNaN(areaOVERAMOUNT13)){
	areaOVERAMOUNT13=0;
}
var areaOVERAMOUNT14 = parseFloat(document.getElementById('areaOVERAMOUNT14').value);
if(isNaN(areaOVERAMOUNT14)){
	areaOVERAMOUNT14=0;
}
var areaOVERAMOUNT15 = parseFloat(document.getElementById('areaOVERAMOUNT15').value);
if(isNaN(areaOVERAMOUNT15)){
	areaOVERAMOUNT15=0;
}
var areaOVERAMOUNT16 = parseFloat(document.getElementById('areaOVERAMOUNT16').value);
if(isNaN(areaOVERAMOUNT16)){
	areaOVERAMOUNT16=0;
}
var areaOVERAMOUNT17 = parseFloat(document.getElementById('areaOVERAMOUNT17').value);
if(isNaN(areaOVERAMOUNT17)){
	areaOVERAMOUNT17=0;
}
var areaOVERAMOUNT18 = parseFloat(document.getElementById('areaOVERAMOUNT18').value);
if(isNaN(areaOVERAMOUNT18)){
	areaOVERAMOUNT18=0;
}
var areaOVERAMOUNT19 = parseFloat(document.getElementById('areaOVERAMOUNT19').value);
if(isNaN(areaOVERAMOUNT19)){
	areaOVERAMOUNT19=0;
}
var areaOVERAMOUNT20 = parseFloat(document.getElementById('areaOVERAMOUNT20').value);
if(isNaN(areaOVERAMOUNT20)){
	areaOVERAMOUNT20=0;
}
var areaOVERAMOUNT21 = parseFloat(document.getElementById('areaOVERAMOUNT21').value);
if(isNaN(areaOVERAMOUNT21)){
	areaOVERAMOUNT21=0;
}
var areaOVERAMOUNT22 = parseFloat(document.getElementById('areaOVERAMOUNT22').value);
if(isNaN(areaOVERAMOUNT22)){
	areaOVERAMOUNT22=0;
}
...
+areaOVERAMOUNT16+areaOVERAMOUNT17+areaOVERAMOUNT18+areaOVERAMOUNT19+areaOVERAMOUNT20+areaOVERAMOUNT21+areaOVERAMOUNT22;
var areaOverAmountSum1= areaOverAmountSum.toFixed(1);
document.getElementById('areaOverAmount').innerHTML=areaOverAmountSum1;
document.getElementById('nowOverAmount').innerHTML=areaOverAmountSum1;
//五线七口维度汇总计算

                        
var fiveSALEAMOUNT1 = parseFloat(document.getElementById('fiveSALEAMOUNT1').value); 
if(isNaN(fiveSALEAMOUNT1)){
	fiveSALEAMOUNT1=0;
}

var fiveSALEAMOUNT2 = parseFloat(document.getElementById('fiveSALEAMOUNT2').value);
if(isNaN(fiveSALEAMOUNT2)){
	fiveSALEAMOUNT2=0;
}
var fiveSALEAMOUNT3 = parseFloat(document.getElementById('fiveSALEAMOUNT3').value);
if(isNaN(fiveSALEAMOUNT3)){
	fiveSALEAMOUNT3=0;
}
var fiveSALEAMOUNT4 = parseFloat(document.getElementById('fiveSALEAMOUNT4').value);
if(isNaN(fiveSALEAMOUNT4)){
	fiveSALEAMOUNT4=0;
}
var fiveSALEAMOUNT5 = parseFloat(document.getElementById('fiveSALEAMOUNT5').value);
if(isNaN(fiveSALEAMOUNT5)){
	fiveSALEAMOUNT5=0;
}
var fiveSALEAMOUNT6 = parseFloat(document.getElementById('fiveSALEAMOUNT6').value);
if(isNaN(fiveSALEAMOUNT6)){
	fiveSALEAMOUNT6=0;
}
var fiveSALEAMOUNT7 = parseFloat(document.getElementById('fiveSALEAMOUNT7').value);
if(isNaN(fiveSALEAMOUNT7)){
	fiveSALEAMOUNT7=0;
}
var fiveSALEAMOUNT8 = parseFloat(document.getElementById('fiveSALEAMOUNT8').value);
if(isNaN(fiveSALEAMOUNT8)){
	fiveSALEAMOUNT8=0;
}
var fiveSALEAMOUNT9 = parseFloat(document.getElementById('fiveSALEAMOUNT9').value);
if(isNaN(fiveSALEAMOUNT9)){
	fiveSALEAMOUNT9=0;
}
var fiveSALEAMOUNT10 = parseFloat(document.getElementById('fiveSALEAMOUNT10').value);
if(isNaN(fiveSALEAMOUNT10)){
	fiveSALEAMOUNT10=0;
}
var fiveSALEAMOUNT11 = parseFloat(document.getElementById('fiveSALEAMOUNT11').value);
if(isNaN(fiveSALEAMOUNT11)){
	fiveSALEAMOUNT11=0;
}
var fiveSALEAMOUNT12 = parseFloat(document.getElementById('fiveSALEAMOUNT12').value);
if(isNaN(fiveSALEAMOUNT12)){
	fiveSALEAMOUNT12=0;
}
var fiveSALEAMOUNT13 = parseFloat(document.getElementById('fiveSALEAMOUNT13').value);
if(isNaN(fiveSALEAMOUNT13)){
	fiveSALEAMOUNT13=0;
}
var fiveSALEAMOUNT14 = parseFloat(document.getElementById('fiveSALEAMOUNT14').value);
...
var fiveSaleAmountSum1= fiveSaleAmountSum.toFixed(1);
document.getElementById('fiveSaleAmount').innerHTML=fiveSaleAmountSum1; 
 
 //五线七口收入汇总计算
var fiveINCOME1 = parseFloat(document.getElementById('fiveINCOME1').value); 
if(isNaN(fiveINCOME1)){
	fiveINCOME1=0;
}

var fiveINCOME2 = parseFloat(document.getElementById('fiveINCOME2').value);
if(isNaN(fiveINCOME2)){
	fiveINCOME2=0;
}
var fiveINCOME3 = parseFloat(document.getElementById('fiveINCOME3').value);
if(isNaN(fiveINCOME3)){
	fiveINCOME3=0;
}
var fiveINCOME4 = parseFloat(document.getElementById('fiveINCOME4').value);
if(isNaN(fiveINCOME4)){
	fiveINCOME4=0;
}
var fiveINCOME5 = parseFloat(document.getElementById('fiveINCOME5').value);
if(isNaN(fiveINCOME5)){
	fiveINCOME5=0;
}
var fiveINCOME6 = parseFloat(document.getElementById('fiveINCOME6').value);
if(isNaN(fiveINCOME6)){
	fiveINCOME6=0;
}
var fiveINCOME7 = parseFloat(document.getElementById('fiveINCOME7').value);
if(isNaN(fiveINCOME7)){
	fiveINCOME7=0;
}
var fiveINCOME8 = parseFloat(document.getElementById('fiveINCOME8').value);
if(isNaN(fiveINCOME8)){
	fiveINCOME8=0;
}
var fiveINCOME9 = parseFloat(document.getElementById('fiveINCOME9').value);
if(isNaN(fiveINCOME9)){
	fiveINCOME9=0;
}
var fiveINCOME10 = parseFloat(document.getElementById('fiveINCOME10').value);
if(isNaN(fiveINCOME10)){
	fiveINCOME10=0;
}
var fiveINCOME11 = parseFloat(document.getElementById('fiveINCOME11').value);
if(isNaN(fiveINCOME11)){
	fiveINCOME11=0;
}
var fiveINCOME12 = parseFloat(document.getElementById('fiveINCOME12').value);
if(isNaN(fiveINCOME12)){
	fiveINCOME12=0;
}
var fiveINCOME13 = parseFloat(document.getElementById('fiveINCOME13').value);
if(isNaN(fiveINCOME13)){
	fiveINCOME13=0;
}
var fiveINCOME14 = parseFloat(document.getElementById('fiveINCOME14').value);
...
var fiveIncomeAmountSum1= fiveIncomeAmountSum.toFixed(1);
document.getElementById('fiveIncomeAmount').innerHTML=fiveIncomeAmountSum1; 
 
 //五线七口毛利计算汇总

var fiveMAORI1 = parseFloat(document.getElementById('fiveMAORI1').value); 
if(isNaN(fiveMAORI1)){
	fiveMAORI1=0;
}

var fiveMAORI2 = parseFloat(document.getElementById('fiveMAORI2').value);
if(isNaN(fiveMAORI2)){
	fiveMAORI2=0;
}
var fiveMAORI3 = parseFloat(document.getElementById('fiveMAORI3').value);
if(isNaN(fiveMAORI3)){
	fiveMAORI3=0;
}
var fiveMAORI4 = parseFloat(document.getElementById('fiveMAORI4').value);
if(isNaN(fiveMAORI4)){
	fiveMAORI4=0;
}
var fiveMAORI5 = parseFloat(document.getElementById('fiveMAORI5').value);
if(isNaN(fiveMAORI5)){
	fiveMAORI5=0;
}
var fiveMAORI6 = parseFloat(document.getElementById('fiveMAORI6').value);
if(isNaN(fiveMAORI6)){
	fiveMAORI6=0;
}
var fiveMAORI7 = parseFloat(document.getElementById('fiveMAORI7').value);
if(isNaN(fiveMAORI7)){
	fiveMAORI7=0;
}
var fiveMAORI8 = parseFloat(document.getElementById('fiveMAORI8').value);
if(isNaN(fiveMAORI8)){
	fiveMAORI8=0;
}
var fiveMAORI9 = parseFloat(document.getElementById('fiveMAORI9').value);
if(isNaN(fiveMAORI9)){
	fiveMAORI9=0;
}
var fiveMAORI10 = parseFloat(document.getElementById('fiveMAORI10').value);
if(isNaN(fiveMAORI10)){
	fiveMAORI10=0;
}
var fiveMAORI11 = parseFloat(document.getElementById('fiveMAORI11').value);
if(isNaN(fiveMAORI11)){
	fiveMAORI11=0;
}
var fiveMAORI12 = parseFloat(document.getElementById('fiveMAORI12').value);
if(isNaN(fiveMAORI12)){
	fiveMAORI12=0;
}
var fiveMAORI13 = parseFloat(document.getElementById('fiveMAORI13').value);
if(isNaN(fiveMAORI13)){
	fiveMAORI13=0;
}
var fiveMAORI14 = parseFloat(document.getElementById('fiveMAORI14').value);
...
var fiveMAORIAmountSum1= fiveMAORIAmountSum.toFixed(1);
document.getElementById('fiveMaoriAmount').innerHTML=fiveMAORIAmountSum1; 
...
function cityAmount(obj) {  
    ...
    $('#modalOVERAMOUNTS').modal('show');  
     ...
     if(city=="4"){
    	    $('#modalIncomeCity').modal('show');  
    		 }
     if(city=="5"){
 	    $('#modalOverCity').modal('show');  
 		 }
...
function updateCityNew(obj) {  
	...
	*/
	...
	var date={BRANDNAME,SPEC,
AREANAME_GZ,SALEAMOUNTS_GZ,
AREANAME_ZQ,SALEAMOUNTS_ZQ,
AREANAME_QY,SALEAMOUNTS_QY,
AREANAME_SG,SALEAMOUNTS_SG,
AREANAME_YF, SALEAMOUNTS_YF,
AREANAME_SZ,SALEAMOUNTS_SZ,
AREANAME_ST,SALEAMOUNTS_ST,
AREANAME_JY, SALEAMOUNTS_JY,
AREANAME_MZ,SALEAMOUNTS_MZ,
AREANAME_CZ,SALEAMOUNTS_CZ,
AREANAME_SW,SALEAMOUNTS_SW,
AREANAME_DG,SALEAMOUNTS_DG,
AREANAME_ZS,SALEAMOUNTS_ZS,
AREANAME_HZ,SALEAMOUNTS_HZ,
AREANAME_ZH,SALEAMOUNTS_ZH,
AREANAME_HY,SALEAMOUNTS_HY,
AREANAME_FS,SALEAMOUNTS_FS,
AREANAME_JM,SALEAMOUNTS_JM,
AREANAME_ZJ,SALEAMOUNTS_ZJ,
AREANAME_MM,SALEAMOUNTS_MM,
AREANAME_YJ,SALEAMOUNTS_YJ,tend};  
...
function updateCityIncome(obj) {  
	...
	*/
	...
	var date={BRANDNAME,SPEC,AREANAME_GZ,INCOMES_GZ,
AREANAME_ZQ,INCOMES_ZQ,
AREANAME_QY,INCOMES_QY,
AREANAME_SG,INCOMES_SG,
AREANAME_YF,INCOMES_YF,
AREANAME_SZ,INCOMES_SZ,
AREANAME_ST,INCOMES_ST,
AREANAME_JY,INCOMES_JY,
AREANAME_MZ,INCOMES_MZ,
AREANAME_CZ,INCOMES_CZ,
AREANAME_SW,INCOMES_SW,
AREANAME_DG,INCOMES_DG,
AREANAME_ZS,INCOMES_ZS,
AREANAME_HZ,INCOMES_HZ,
AREANAME_ZH,INCOMES_ZH,
AREANAME_HY,INCOMES_HY,
AREANAME_FS,INCOMES_FS,
AREANAME_JM,INCOMES_JM,
AREANAME_ZJ,INCOMES_ZJ,
AREANAME_MM,INCOMES_MM,
AREANAME_YJ,INCOMES_YJ,tend};  

 if(obj=="1"){
  
  $.ajax({  
        type: "post",  
        url: "../parameterSet/addAndUpdateCityDateIncome.do",  
        data:date,  
        dataType: 'json',  
        contentType: "application/x-www-form-urlencoded; charset=utf-8",  
        success: function(result) {  
...
//城市维度提交更改 覆盖客户数
function updateCityNewOver(obj) {  
    //获取模态框数据  
...
var date={BRANDNAME,SPEC,AREANAME_GZ,OVERAMOUNTS_GZ,
AREANAME_ZQ,OVERAMOUNTS_ZQ,
AREANAME_QY,OVERAMOUNTS_QY,
AREANAME_SG,OVERAMOUNTS_SG,
AREANAME_YF,OVERAMOUNTS_YF,
AREANAME_SZ,OVERAMOUNTS_SZ,
AREANAME_ST,OVERAMOUNTS_ST,
AREANAME_JY,OVERAMOUNTS_JY,
AREANAME_MZ,OVERAMOUNTS_MZ,
AREANAME_CZ,OVERAMOUNTS_CZ,
AREANAME_SW,OVERAMOUNTS_SW,
AREANAME_DG,OVERAMOUNTS_DG,
AREANAME_ZS,OVERAMOUNTS_ZS,
AREANAME_HZ,OVERAMOUNTS_HZ,
AREANAME_ZH,OVERAMOUNTS_ZH,
AREANAME_HY,OVERAMOUNTS_HY,
AREANAME_FS,OVERAMOUNTS_FS,
AREANAME_JM,OVERAMOUNTS_JM,
AREANAME_ZJ,OVERAMOUNTS_ZJ,
AREANAME_MM,OVERAMOUNTS_MM,
AREANAME_YJ,OVERAMOUNTS_YJ,tend};  

 if(obj=="1"){
  
  $.ajax({  
        type: "post",  
        url: "../parameterSet/addAndUpdateCityDateOver.do",  
        data:date,  
        dataType: 'json',  
        contentType: "application/x-www-form-urlencoded; charset=utf-8",  
        success: function(result) {  
