...
<table border="1" bordercolor="#1addfa" id="table5">
			...
			<tr>
                ...
                <td colspan="2" class="DTamount" align="center">动态规划价差（台）</td>
                <td colspan="2" class="nowXL" align="center">当前价差</td>
                <td rowspan="2" class="DBamount" align="center">对标品价差</td>
                <td rowspan="2" class="JPamount" align="center">竞品价差</td>
			...
			<tr>
				...
				<td class="DTamount">累计规划价差</td>
				<td class="DTamount">本周规划价差</td>
				<td class="nowXL">累计价差</td>
				<td class="nowXL">本周价差</td>
