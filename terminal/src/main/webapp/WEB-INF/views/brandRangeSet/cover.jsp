...
<table border="1" bordercolor="#1addfa" id="table5">
			...
			<tr>
                ...
                <td colspan="2" class="nowXL" align="center">当前覆盖量</td>
                <td rowspan="2" class="DBamount" align="center">对标品覆盖量</td>
                <td rowspan="2" class="JPamount" align="center">竞品覆盖量</td>
                <td colspan="3" class="healthLife" align="center">覆盖规划健康性</td>
			...
			<tr>			
				...
				<td class="DTamount">累计规划覆盖量</td>
				<td class="DTamount">本周规划覆盖量</td>
				<td class="nowXL">累计覆盖量</td>
				<td class="nowXL">本周覆盖量</td>
