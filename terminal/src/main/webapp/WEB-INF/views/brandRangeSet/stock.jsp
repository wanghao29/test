...
<table border="1" bordercolor="#1addfa" id="table5">
			...
			<tr>
                ...
                <td colspan="2" class="nowXL" align="center">当前库存</td>
                <td rowspan="2" class="DBamount" align="center">对标品库存</td>
                <td rowspan="2" class="JPamount" align="center">竞品库存</td>
                <td colspan="3" class="healthLife" align="center">库存规划健康性</td>
			...
			<tr>			
				...
				<td class="nowXL">累计库存</td>
				<td class="nowXL">本周库存</td>
