...
<body style="overflow-x:hidden;min-width: 1508px;">
	...
	<span style="color: #33ffff;font-size: 20px;">地市KPI全景   / 2019地市KPI第一季度</span>
	</div>
	</div>
				...
				<div class="modal-dialog">
					...
					<form id="uploadForm" enctype="multipart/form-data">
						<div class="modal-body">
							...
							<br/>
							<span> 选择季度：</span>
		   <select name="tName" id="Hname" class="select">			
				<option value="1">第一季度</option>
				<option value="2">第二季度</option>
				<option value="3">第三季度</option>
				<option value="4">第四季度</option>
			</select>
							<a style="color:white;" href="<%=basePath%>resources/tmpl/kpiCity.xlsx">模板下载</a>
						</div>
					</form>
...
<table id="tptable"  border="1px red" align="center" style="word-break:break-all; word-wrap:break-word;height: 600px;width: 1000px;border: 1px solid #037abd; font-size: 18px;text-align: center;">
   ...
   <tr style="background-color: #037abd;border: #8B7D6B;">  
    ...
    <td id="guang1" class="guangzhou" colspan="18" style='text-align: center;border: white;color: #5bfdff';>1季度</td> 
    <td class="shenzhen" colspan="21" style='text-align: center;border: white;color: #5bfdff'>1季度</td> 
    <td class="foshan" colspan="18" style='text-align: center;border: white;color: #5bfdff'>1季度</td>
    <td class="dongguan" colspan="18" style='text-align: center;border: white;color: #5bfdff'>1季度</td> 
   </tr>
