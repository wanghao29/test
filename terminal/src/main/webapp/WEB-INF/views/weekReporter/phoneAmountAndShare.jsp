  ...
  <div class="row" style=" margin: 20px;z-index: 1000;">
		<!-- 表头控件 -->
			...
			<select name="times" id="times" onchange ="changeTime()"
				style="border-color: #1addfa;text-align:center; width: 100px; color: white;
	  ...
	  <div class="col-xs-3" style="display:none"  id="dayes">
		...
		<input name="day1" id="day1" 
			type="text" style="width:30%;text-align:center;height: 30px;  background-color: #00063c; 
		...
		<label
		 ...
		 <select name="times" id="tim"
				style="border-color: #1addfa; width: 100px;text-align:center; color: white;
				 background-color: #00063c; height: 30px;border-radius: 16px; ">
      ...
      <div class="col-xs-3"  id="mon">
		<label
			...
			type="text" style="width:30%;text-align:center;height: 30px;  background-color: 
...
<p align="center" style="font-size: 30px;margin:50px; color: #1addfa;">合约机销量及份额</p>		
   
   
   

<div class="row" style=" margin: 100px;z-index: 1000;">
<div class="col-xs-12">
...
function getPaint10(container10,title,mapData){			
 ...
 function btn(){
	...
	if(times=='day'){
	 ...
	 $.ajax({  
	        url: "../contractPhoneAmountAndShare/sale.do",  
	        type: "post", 
	        async: false,  
	        cache: false,  
	        dataType: "json",  
	...
	if(times=='month'){
	 ...
	 $.ajax({  
	        url: "../contractPhoneAmountAndShare/saleMonth.do",  
	        type: "post", 
	        async: false,  
	        cache: false,  
	        dataType: "json",  
	...
	if(times=='year'){
	 ...
	 $.ajax({  
	        url: "../contractPhoneAmountAndShare/saleYear.do",  
	        type: "post", 
	        async: false,  
	        cache: false,  
	        dataType: "json",  
...
//页面一加载就执行的js方法
 ...
 function documentOnload(){
	 ...
	 var month1=document.getElementById("month1").value = "2019-04";
	 var month2=document.getElementById("month2").value = "2019-10";
	// var month1='2018-09';//开始月
		
	// var month2='2019-03';//结束月 
