...
<div class="row">
        ...
        <div class="row" style="margin-left:5px;">  
			...
			<div class="col-xs-1">	 				
   	        	<input name="startMonth" id="startMonth" type="text" style="width:100%" readonly="readonly" class="form-text select "
   	  			onClick="WdatePicker({dateFmt:'yyyyMM',maxDate:'#F{$dp.$D(\'endMonth\')}'})" value="${vo.startMonth}"/>			       	
			</div>
			<div class="col-xs-1"> 	 				
   	        	<input name="endMonth" id="endMonth" type="text" style="width:100%" readonly="readonly" class="form-text select "
   	  			onClick="WdatePicker({dateFmt:'yyyyMM',minDate:'#F{$dp.$D(\'startMonth\')}',maxDate:'%y-{%M-1}'})" value="${vo.endMonth}"/>			       	
			</div> 			
				<div class="col-xs-1" >
			...
			<div class="col-xs-1" style="margin-left:1%;"> 
				<button type="button" 
					onclick="exportExcel('list','客商常态特征')" 
        ...
        <div class="row" style="margin-left:5px;margin-top:5px;">  
            <div class="col-xs-2">
		        <div class="input-group">
		            ...
		            <input type="text" name="code_normalModal" class="form-control" value="${vo.code}">		            
		        </div>	
		    </div>
      <div class="col-xs-2" style="margin-left:1%;">
		        <div class="input-group">
		        	<span class="input-group-addon">客商名称</span>
		            <input type="text" name="name_normalModal" class="form-control" value="${vo.name}">		            
		        </div>	
		    </div> 
            <div class="col-xs-2" style="margin-left:1%;">
		        <div class="input-group">
	...
	<div  class="row" >
		<p><span class="title-no-border"><span style="background-color: #5bfdff;">|</span >&nbsp;可选展示指标</span></p>
		<div  class="col-xs-12">
			<div class="panel panel-default jqgrid_width">
				  <div class="panel-body"id="all_field" >				       
	       		    ...
	       		    <ul class="conditions_select" >	
                        ...
                        <li><label><input type="checkbox" value="orgacode"  class="type1" checked />&nbsp;渠道客户编码</label></li>	       		    	
                        <li><label><input type="checkbox" value="custname"  class="type1" checked />&nbsp;渠道客户名称</label></li>	       		    	
                     ...
                     <ul class="conditions_select" >	
                        ...
                        <li><label><input type="checkbox" value="pricecnt13"  class="type5" />&nbsp;价位1700-1999</label></li>
                        <li><label><input type="checkbox" value="pricecnt14"  class="type5" />&nbsp;价位2000-2999</label></li>                        
                        <li><label><input type="checkbox" value="pricecnt15"  class="type5" />&nbsp;价位3000-3999</label></li>
                        <li><label><input type="checkbox" value="pricecnt16"  class="type5" />&nbsp;价位4000-4999</label></li>
                        <li><label><input type="checkbox" value="pricecnt17"  class="type5" />&nbsp;价位5000+</label></li>
...
<!-- 
 ...
 --> 		
    ...
    <div  class="row">	
    	...
    	<div class="col-xs-12" style="padding-left:10px;min-height:180px;">
    	       <table id="list"></table> 
			   <div id="pager"></div>
		  </div> 	
 	</div>	
...
function jqgridInit(){
	var colNames = [ 
	                  '月份','地市','渠道客户编码','渠道客户名称','联系人姓名','联系人电话',   //6
	                     '存量用户数','DM窜货量','客流量','预计换机用户数','男性数量','女性数量','arpu(元)','mou(分钟)','dou(M)',  //9
	                     ...
	                     '价位未知','价位0-99','价位100-299','价位300-399','价位400-499','价位500-599','价位600-699','价位700-799','价位800-899','价位900-999',
	                 	   '价位1000-1099','价位1100-1499','价位1500-1699','价位1700-1999','价位2000-2999','价位3000-3999','价位4000-4999','价位5000+',  //18
	                     /*'流量<0',*/'流量0M','流量0-10M','流量10-50M','流量50-100M','流量100-200M','流量200-300M','流量300-500M','流量500-1G','流量1-3G','流量3G+', //11
	                     /*'<0',*/'0元','0-50元','50-80元','80-120元','120+元',  //6
	                     /*'<0分种',*/' 0分种',' 0-60分种','60-120分种','120-240分种','240-360分种','360-600分种','600+分种', //8
	                     '主套餐未知','主套餐<18','主套餐18-28','主套餐28-38','主套餐38-48','主套餐48-58','主套餐58-88','主套餐88-138','主套餐138-158','主套餐158-188',
	               	    '主套餐188-238','主套餐238-268','主套餐268-288','主套餐288-338','主套餐338-588','主套餐588+'  //16
		           ];
	...
	var colModel = [ 
	            ...
	            {name : 'tel',index : 'tel',sorttype : "int",searchoptions:{sopt:['eq','lt','le','gt','ge','ne','cn']}},
	...
	jqgrid_init("list","pager","${basePath}customerIdentifyInfo/listCustNormal.do",{},colNames,colModel,"orgacode");
}
...
function list_setGroupHeaders(){
	  ...
	  jQuery("#list").jqGrid('setGroupHeaders', {
		    ...
		    groupHeaders:[
		    {startColumnName: 'statMonth', numberOfColumns: 15, titleText: '基础信息'},
...
function showCusOrgacode(customers){	
    ...
    $("#"+id).empty(); 
      for(var i=0;i<customers.length;i++){
		       if(customers[i].text == "全部"){
		          delete customers[i]; //删除并返回数组的第一个元素
		         break;
		         }
		      }      
