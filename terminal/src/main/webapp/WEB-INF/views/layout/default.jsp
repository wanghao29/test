...
%>
	...
	<link href="<%=basePath%>resources/css/plugin/hplus/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">
    <!-- Morris -->
 <%--    <link href="<%=basePath%>resources/css/hplus/plugins/morris/morris-0.4.3.min.css" rel="stylesheet"> --%>
    <link href="<%=basePath%>resources/css/plugin/hplus/animate.min.css" rel="stylesheet">
<%--     <link href="<%=basePath%>resources/css/plugin/hplus/style.min862f.css?v=4.1.0" rel="stylesheet">
 --%>    
	  ...
	  <div id="menu" class="col-xs-5" style="border-color: green;">
			  <ul class=" " style="width: 100%;">
			        ...
			        <%--  <li id="customerChannel"><a class="a" href="<%=basePath%>customerChannel/index.do" style="font-size:20px;" >渠道客户画像</a></li> --%>
			         <li id="customerChannel"><a class="a" href="#" style="font-size:20px;" >渠道画像</a>
			          <ul class="subnav">
			          <li><a class="a" href="<%=basePath%>customerChannel/index.do" style="font-size:20px;" >客户画像</a></li>
			          <li><a class="a" href="<%=basePath%>customerChannel/hall.do" style="font-size:20px;" >厅店画像</a></li>
			          </ul>
			         </li>
			         </shiro:hasPermission>
...
--%>
		        ...
		        <a  class="a" href="<%=basePath%>admin/user/list.do" title="返回首页"  style="font-size:20px;">返回首页<em class="back-icon"></em></a>
		  </ul>
	 </div>
	</div>
		  ...
		  <div class="col-xs-2 " style="border-color: red;float: left;">
				...
				<div class=" col-xs-5" style="border-color: green;float: left;min-width: 507px;">
						  <ul class=" " style="width: 100%;">
						        ...
						        <a   class="a" href="<%=basePath%>admin/user/list.do" title="返回首页"  style="font-size:24px;" >返回首页<em class="back-icon"></em></a>
						  </ul>
				</div>
		</div>
				  ...
				  <ul class=" " style="width: 100%; ">
					   ...
					   <li id="businessIncome" class="active drop" >
				        <a   class="a"  href="#" style="font-size:24px;">基础项</a>
				          <ul class="subnav" style="width: 180px;">
				                <shiro:hasPermission name="businessIncome:list">   
				                	<li  ><a  class="a" href="<%=basePath%>operateIncome/index.do?special=GFKPI"  style="font-size:16px;">运营收入</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="terminalSales:list">   
				                	<li  ><a  class="a" href="<%=basePath%>ownBrandIncome/index.do?special=GFKPI" style="font-size:16px;">自有品牌手机收入</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="stockTurnoverRatio:list">   
				                	<li  ><a  class="a" href="<%=basePath%>ownBrandMultiIncome/index.do?special=GFKPI" style="font-size:16px;">自有品牌多形态终端收入</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="salesShare4G:list">   
				                	<li  ><a  class="a" href="<%=basePath%>ownBrandOtherMultiIncome/index.do?special=GFKPI" style="font-size:16px;">自有品牌其他多形态终端收入</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="customerTargetValue:list">  
				                	<li  ><a  class="a" href="<%=basePath%>qualityCustomerTargetValue/index.do?special=GFKPI" style="font-size:16px;">优质客户目标值</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="repaymentAccuracyForecast:list">  
				                	<li  ><a  class="a" href="<%=basePath%>kaPhonesSalesTargetValue/index.do?special=GFKPI" style="font-size:16px;">KA客户手机销量目标值</a></li>		                  					      
						        </shiro:hasPermission>
						        <shiro:hasPermission name="accountReceivableTurnoverRatio:list">  
						        	<li  ><a  class="a" href="<%=basePath%>netPhonesSalesProportion/index.do?special=GFKPI" style="font-size:16px;">网内战略型手机销量占比</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="feeProgressBalance:list">
				                	<li  ><a  class="a" href="<%=basePath%>netPhonesSalesProportion/index.do?special=GFKPI" style="font-size:16px;">内部支撑满意度</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="businessIncome:list">
				                	<li  ><a  class="a" href="<%=basePath%>inventoryTurnover/index.do?special=GFKPI"  style="font-size:16px;">存货周转率</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="socialChannelExpand:list">
				                	<li  ><a  class="a" href="<%=basePath%>threeStockValueProportion/index.do?special=GFKPI" style="font-size:16px;">三个月以上存货原值占比</a></li>
				                </shiro:hasPermission>
				                <shiro:hasPermission name="terminalSales:list">
				                	<li  ><a  class="a" href="<%=basePath%>backForecastAccuracy/index.do?special=GFKPI" style="font-size:16px;">回款预测准确度</a></li> 	
				                </shiro:hasPermission>
				                <shiro:hasPermission name="corporationCollaboration:list">
				                	<li  ><a  class="a" href="<%=basePath%>receivableTurnoverRate/index.do?special=GFKPI" style="font-size:16px;">应收周转率</a></li>
				           		</shiro:hasPermission>
				           		<shiro:hasPermission name="grossProfitRatio:list">
				           			<li  ><a  class="a" href="<%=basePath%>threeReceivableProportion/index.do?special=GFKPI" style="font-size:16px;">三个月以上应收账款占比</a></li>
						        </shiro:hasPermission>
						        <shiro:hasPermission name="threeMonthStockRatio:list">
						        	<li  ><a  class="a" href="<%=basePath%>totalProfit/index.do?special=GFKPI" style="font-size:16px;">利润总额</a></li>
						        </shiro:hasPermission>
						        <shiro:hasPermission name="businessIncome:list">
						        	<li  ><a  class="a" href="<%=basePath%>unitCostProfit/index.do?special=GFKPI"  style="font-size:16px;">单位人工费用创利比</a></li>
						        </shiro:hasPermission>
						     <%--    <shiro:hasPermission name="accountReceivableRatio:list">
						        	<li  ><a  class="a" href="<%=basePath%>assetsTurnoverRate/accountReceivableRatio/index.do?special=MONITOR" style="font-size:16px;">三个月以上应收账款占比</a></li>
				         		</shiro:hasPermission> --%>
				...
				<div class=" col-xs-5" style="border-color: green;float: left;min-width: 507px;">
					...
					<%-- 	        <li id="assetsTurnoverRate" class="drop"><a   class="a"  href="#" style="font-size:24px;">加分项</a>
						       ...
						       <%--   <li id="pointOption" class="drop"><a   class="a"  href="#" style="font-size:24px;">扣分项</a>
						        ...
						        <a   class="a" href="<%=basePath%>entry/newIndex.do?special=MONITOR" title="返回首页"  style="font-size:24px;" >返回首页<em class="back-icon"></em></a>
						  </ul>
				</div>
		</div>
					       ...
					       <shiro:hasPermission name="deposit:list">
					         ...
					         <shiro:hasPermission name="back:list">
							   ...
							   <c:if test="${type_8 != '回'}">
						          ...
						          <a   class="a" href="<%=basePath%>admin/user/list.do" title="返回首页"  style="font-size:24px;" >返回首页 </a>
						          <a   class="a" href="<%=basePath%>/entry/newIndex.do?special=MONITOR" title="返回重点kpi全景"  style="font-size:24px;" ><em class="back-icon"></em></a> 
						  </ul>
				</div>
		</div>
	...
	<div class="row" id="menu">
		...
		<ul class=" ">
			<shiro:hasPermission name="zdResultCitykpiQ:list">  
				...
				<%-- <li class="drop" id="zdKpiImptProdtKPI" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a class="a" href="<%=basePath%>zdResultCitykpi2019/index.do" style="font-size:20px;">2019地市KPI</a>
			     </li> --%>
			</shiro:hasPermission>
...
<!--KPI2019页面重置  -->
<c:if test="${special == 'cityKpi2019'}">
	<div class="row" id="menu">
		<div class="col-xs-5" style="border-color: green;float: left;min-width: 550px;>   
			<ul class=" " style="width: 100%; ">
				<shiro:hasPermission name="zdKpiCompltVal:list">  
				     <li class="drop" id="zdKpiCompltVal111" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a class="a" href="<%=basePath%>zdResultCitykpi2019/allList.do?quarter=1" style="font-size:20px;">2019地市KPI</a>&nbsp;&nbsp;
					 </li>
				</shiro:hasPermission>
				<shiro:hasPermission name="zdKpiGoalVal:list">  
					<%-- <li class="drop" id="zdKpiGoalVal" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a class="a" href="<%=basePath%>zdKpiGoalVal/index.do" style="font-size:20px;"></a>&nbsp;&nbsp;
					</li> --%>
				</shiro:hasPermission>
				<shiro:hasPermission name="zdKpiImptProdt:list">  
					<%-- <li class="drop" id="zdKpiImptProdt" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a class="a" href="<%=basePath%>zdKpiImptProdt/index.do" style="font-size:20px;"></a>
			        </li> --%>
		        </shiro:hasPermission>
		...
		<ul class=" ">
			...
			<shiro:hasPermission name="calcResultIndex:list">  
				<%--  <li style="float:right;" class="drop" id="zdKpiCompltVal111" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a class="a" href="<%=basePath%>zdResultCitykpi2019/allList.do?quarter=1" style="font-size:20px;">2019地市KPI</a>&nbsp;&nbsp;
					 </li> --%>
			</shiro:hasPermission>
			
			<!--返回首页  -->
			 <li style="position: relative;left: 200px;"><a href="<%=basePath%>entry/newIndex.do?special=MONITOR" style="font-size:24px;">返回上一页</a></li>
			 <li></li> 
			<a class="a" href="<%=basePath%>admin/user/list.do" title="返回首页"  style="font-size:24px;" ><em class="back-icon"></em></a>
		</ul>
	</div>
...
<c:if test="${special == 'model5g'}">
	<div class="row" id="menu">
		<div class="col-xs-5" style="border-color: green;float: left;min-width: 550px;>   
			<ul class=" " style="width: 100%; ">
				<shiro:hasPermission name="zdKpiCompltVal:list">  
				     <li class="drop" id="zdKpiCompltVal111" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a class="a" href="<%=basePath%>model5Gdate/modelList.do?pageNumber=1" style="font-size:20px;">期初数据</a>&nbsp;&nbsp;
					 </li>
				</shiro:hasPermission>
				<%-- <shiro:hasPermission name="zdKpiGoalVal:list">  
					 <li class="drop" id="zdKpiGoalVal111" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a class="a" href="<%=basePath%>broken/modelList.do?pageNumber=1" style="font-size:20px;">碎屏险期初数据</a>&nbsp;&nbsp;
					</li> 
				</shiro:hasPermission> --%>
				<shiro:hasPermission name="zdKpiImptProdt:list">  
					<%-- <li class="drop" id="zdKpiImptProdt" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
...
<!--互联网数据  -->
<c:if test="${special == 'internet'}">
	<div class="row" id="menu">
		<div class="col-xs-5" style="border-color: green;float: left;min-width: 550px;> 
		<li class="drop"><a  class="a" href="#" style="font-size:24px;" >期初数据2</a> 
					        	 <ul class="subnav">
			...
			<%-- <ul class=" " style="width: 100%; ">
				...
				<shiro:hasPermission name="zdKpiGoalVal:list">  
					 <li class="drop" id="zdKpiGoalVal111" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a class="a" href="<%=basePath%>internet/modelList.do?pageNumber=1" style="font-size:20px;">互联网期初数据</a>&nbsp;&nbsp;
					</li> 
...
<!--互联网期初 数据首页显示 -->
<c:if test="${special == 'modelInternet'}">
	<div class="row" id="menu">
		<div class="col-xs-5" style="border-color: green;float: left;min-width: 550px;>   
			<ul class=" " style="width: 100%; ">
				 <shiro:hasPermission name="zdKpiCompltVal:list">  
				     <li class="drop" id="zdKpiCompltVal111" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
						<a  class="a" href="<%=basePath%>broken/modelList.do?pageNumber=1" style="font-size:24px;" >碎屏险期初数据</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  class="a" href="<%=basePath%>model5Gdate/modelList.do?pageNumber=1" style="font-size:24px;" >期初数据展示</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  class="a" href="<%=basePath%>internet/modelList.do?pageNumber=1" style="font-size:24px;" >互联网数据展示</a>
					 </li>
				</shiro:hasPermission> 
				<!-- <shiro:hasPermission name="zdKpiGoalVal:list">  
					 <li class="drop" id="zdKpiGoalVal111" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
		...
		<ul class=" ">
			 <shiro:hasPermission name="zdResultCitykpiQ:list">  
				<%-- <li class="drop" id="zdResultCitykpiQ" ms-click="activeClass(this)"  ms-click-1="skip('flowMonitor.html')">
					<a  class="a" href="<%=basePath%>internet/modelList.do?pageNumber=1" style="font-size:24px;" >互联网数据展示</a>
				</li> --%>
			...
			<!--返回首页  -->
			 <li style="position: relative;left: 200px;"><a href="<%=basePath%>amount/index.do?type_8=量&special=type_8" style="font-size:24px;">返回上一页</a></li>
			 <li></li> 
			<a class="a" href="<%=basePath%>admin/user/list.do" title="返回首页"  style="font-size:24px;" ><em class="back-icon"></em></a>
		</ul>
	</div>
