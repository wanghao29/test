...
<body>
<script type="text/javascript" src="<%=basePath%>resources/js/socialChannelExpand/customer_target_value.js"></script>
	    ...
	    <div class="row">
		      <div class="col-xs-3">
		         <div class="panel panel-default" style=" width: 100%;">
					  <div class="panel-body" >
					     <p>活跃客户数量</p>
					   	 <h1 id="hHyyhsl" style="float: right;">  </h1>
					  </div>
				  </div>
	  ...
	  <%--</div>--%>
	    ...
	    <div class="row"style="margin-bottom: 10px;">
		  ...
		  <div class="panel panel-default">
			...
			<input type="hidden" id="flag"  value="活跃客户目标值"/><!-- 标记所属的指标 --> 
