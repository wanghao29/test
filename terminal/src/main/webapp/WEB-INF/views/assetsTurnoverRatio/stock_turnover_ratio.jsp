...
<body>
<script type="text/javascript" src="<%=basePath%>resources/js/assetsTurnoverRatio/stock_turnover_ratio.js"></script>
	    ...
	    <div class="row">
		      <div class="col-xs-4">
		         <div class="panel panel-default" style=" width: 100%;">
					  <div class="panel-body" >
					     <p>存货周转率</p>
					   	 <h1 id="hChzzl" style="float: right;">4.19  </h1>
					  </div>
				  </div>
	    ...
	    <div class="row"style="margin-bottom: 10px;">
		  ...
		  <div class="panel panel-default">
			  <div class="panel-body" style=" " >
			  	<div style="font_size:24px; ">月份：<span id="yf" style="color:blue; "></span></div>
				  <div id="char_bar" style="width: 100%;height: 500px;"/>
			  </div>
		  </div>
			<input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
			<input type="hidden" id="flag"  value="存货周转率"/><!-- 标记所属的指标 -->  
	  </div>
 </div>
