...
<title>KA客户手机销量目标值</title>
</head>

<body>
 
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/channelDevelopment/kaPhonesSalesTargetValue.js"></script>
	<style type="text/css">
	table tr td{
	  margin-right: 10px;
	}
	...
	.ui-jqgrid .ui-common-table {
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="KA客户手机销量目标值_19"/><!-- 标记所属的指标 -->
	     <input type="hidden" id="billcyc"  value="${billcyc}"/>
	<div class="row">
		<ol class="breadcrumb">
		 <li>经分监控</li>
		  <li>基础项</li>
		  <li class=" ">KA客户手机销量目标值</li>
		</ol>
	</div>
		  ...
		  <div class="panel panel-default" style=" width: 100%;">
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				    ...
				    <div class="col-xs-4" style="float:right;">
				    	...
				    	<input type="hidden" id="hid_kpikey" value="kaPhonesSalesTargetValue"/><!-- 和权限有关  慎改 -->
				    </div>
					         ...
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">全年完成收入</span>
								   	  <span id="hQnwcsr" style="margin-left: 100px; font-size: 40px;"> </span>  
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  ...
										  <span id="hQnwcd" style="margin-left: 100px; font-size: 55px;"> </span>
								  </div>
							  </div>
					  	     ...
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">时间完成度</span>
								   	 <span id="sjwcd" style="margin-left: 100px; font-size: 55px;">   </span>
								   	 <span style="font-size: 20px;">亿</span>
								  </div>
							  </div>
