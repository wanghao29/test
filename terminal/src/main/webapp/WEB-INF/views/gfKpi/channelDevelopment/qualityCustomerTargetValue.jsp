...
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/channelDevelopment/qualityCustomerTargetValue.js"></script>
	<style type="text/css">
	table tr td{
	  margin-right: 10px;
	}
	...
	.ui-jqgrid .ui-common-table {
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="优质客户目标值_19"/><!-- 标记所属的指标 -->
		  ...
		  <div class="panel panel-default" style=" width: 100%;">
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				    ...
				    <div class="col-xs-4" style="float:right;">
				    	...
				    	<input type="hidden" id="hid_kpikey" value="qualityCustomerTargetValue"/><!-- 和权限有关  慎改 -->
				    </div>
					      ...
					      <div class="col-xs-4">
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">完成度</span>
								   	  <span id="wcd" style="margin-left: 100px; font-size: 50px;"> </span>  
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  <span style="font-size: 20px;">时间进度</span>
										  <span id="sjjd" style="margin-left: 100px; font-size: 50px;"> </span>
								  </div>
							  </div>
				      ...
				      <div class="row">
					            ...
					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins  " id="sjjd" > </h1>
