...
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/operateBenefit/totalProfit.js"></script>
	<style type="text/css">
	table tr td{
	  margin-right: 10px;
	}
...
word-break:break-all;
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="利润总额_19"/><!-- 标记所属的指标 -->
		  ...
		  <div class="panel panel-default" style=" width: 100%;">
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				    ...
				    <div class="col-xs-4" style="float:right;">
				    	...
				    	<input type="hidden" id="hid_kpikey" value="totalProfit"/><!-- 和权限有关  慎改 -->
				    </div>
					      ...
					      <div class="col-xs-4">
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">全年完成利润总额</span>
								   	  <span id="qnwclrze" style="margin-left: 100px; font-size: 40px;"> </span>  
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  ...
										  <span id="qnwcd" style="margin-left: 100px; font-size: 55px;"> </span>
								  </div>
							  </div>
					            ...
					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins" id="qnwclrze" > </h1>
