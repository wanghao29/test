...
@Controller
@RequestMapping("/qualityCustomerTargetValue")
public class QualityCustomerTargetValueController {

	@Resource
	private IQualityCustomerTargetValueService qualityCustomerTargetValueService;
	...
	@DS("dataSource")@RequestMapping(value = "/index", method = RequestMethod.GET)
   	public String newIndex(HttpServletRequest request, Locale locale, Model model, String special, String billcyc) {
   		...
   		return "gfKpi/channelDevelopment/qualityCustomerTargetValue";
   	}
	...
	public JSONObject query(HttpServletRequest req, HttpServletResponse res) {
		...
		try {
			qualityCustomerTargetValueService.calculatedScore(String.valueOf(params.get("startMonth")), String.valueOf(params.get("endMonth")));
			List<QualityCustomerTargetValue> outList = new ArrayList<QualityCustomerTargetValue>();
			PageInfo<QualityCustomerTargetValue> pageInfo =qualityCustomerTargetValueService.queryData(params);
