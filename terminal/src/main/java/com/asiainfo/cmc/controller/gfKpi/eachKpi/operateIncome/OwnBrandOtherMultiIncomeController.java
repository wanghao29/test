...
@Controller
@RequestMapping("/ownBrandOtherMultiIncome")
public class OwnBrandOtherMultiIncomeController {
	@Resource
	private IOwnBrandOtherMultiIncomeService ownBrandOtherMultiIncomeService;
	...
	@DS("dataSource")@RequestMapping(value = "/index", method = RequestMethod.GET)
   	public String newIndex(HttpServletRequest request, Locale locale, Model model, String special, String billcyc) {
   		...
   		return "gfKpi/operateIncome/ownBrandOtherMultiIncome";
   	}
	...
	public JSONObject query(HttpServletRequest req, HttpServletResponse res) {
		...
		try {
			ownBrandOtherMultiIncomeService.calculatedScore(String.valueOf(params.get("startMonth")), String.valueOf(params.get("endMonth")));
			List<OwnBrandOtherMultiIncome> outList = new ArrayList<OwnBrandOtherMultiIncome>();
			PageInfo<OwnBrandOtherMultiIncome> pageInfo =ownBrandOtherMultiIncomeService.queryData(params);
