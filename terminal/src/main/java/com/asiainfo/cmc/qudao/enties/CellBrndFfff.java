 ...
 * 主要品牌基站维度覆盖统计表
 */
public class CellBrndFfff implements Serializable{
	
	private static final long serialVersionUID = 1L;
	
	private String termBrndNam;  //终端品牌名称
	private String cityNam;      //地市名称
	private String cellCnt;     //厅店数量
	private String ttttTyp;      //基站类型2-覆盖程度
	private String num;          //量
	private String rete01;       //高覆盖基站占比
	private String rete02;       //高覆盖基站覆盖客户数占比
	private String rete03;       //中高覆盖基站占比
	private String rete04;       //中高覆盖基站覆盖客户数占比
	private String rete05;       //中覆盖基站占比
	private String rete06;       //中覆盖基站覆盖客户数占比
	private String rete07;       //中低覆盖基站占比
	private String rete08;       //中低覆盖基站覆盖客户数占比
	private String rete09;       //低覆盖基站占比
	private String rete10;       //低覆盖基站覆盖客户数占比
	private String rete11;       //超低覆盖基站占比
	private String rete12;       //超低覆盖基站覆盖客户数占比
	private String rete13;       //零覆盖基站占比
