...
public class IncomePhoneBrand {
    ...
    public IncomePhoneBrand(Integer id, String sr, String srtz, String qnwcsr, String mbz, String sjwcd, String qnwcd, String bysrwcl, String fz, String month,String bywcqk) {
        this.id = id;
        this.sr = sr;
        this.srtz = srtz;
        this.qnwcsr = qnwcsr;
    ...
    public void setSrtz(String srtz) {
        this.srtz = srtz;
    }
