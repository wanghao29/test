...
<div class="row" style="padding-top: 5px;">
	...
	<div class="col-xs-5"  align="right">
	  <div class="col-xs-3"> <button type="button" onclick="query()" class="btn btn-primary" style="width:100px" > 查询</button></div>
	  <div class="col-xs-2"> <button   data-toggle="modal" data-target="#two_fives_monitor_modal" class="btn btn-primary" id ="two_fives_monitor_import" style="width:100px;display:none;" >导入</button></div>
	</div>
	</br>
