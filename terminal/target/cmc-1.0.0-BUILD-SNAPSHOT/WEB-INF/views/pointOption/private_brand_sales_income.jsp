...
<head>
    ...
    <title>自有品牌产品销售收入（+5分）（4+5）</title>

</head>
<body>
<script type="text/javascript" src="<%=basePath%>resources/js/pointOption/private_brand_sales_income.js"></script>
...
<div class="row">
    <div class="panel panel-default" style=" width: 100%;">
        <div class="panel-body" >
            ...
            <div class="row">
                <div class="col-xs-4">
                    <div class="panel panel-default" style=" width: 100%;">
                        <div class="panel-body" >
                            <p>自有品牌手机收入</p>
                            <h1 id="zyppsjsr" style="float: right;">   </h1>
                        </div>
                    </div>
              ...
              <div class="row">
                <div class="col-xs-4">
                    <div class="panel panel-default" style=" width: 100%;">
                        <div class="panel-body" >
                            <p>自有品牌多形态终端收入</p>
                            <h1 id="zyppdxtzdsr" style="float: right;">   </h1>
                        </div>
                    </div>
			...
			<input type="hidden" id="flag"  value="自有品牌产品销售收入"/><!-- 标记所属的指标 --> 
