...
<div class="col-xs-6" style="margin-left:-360px;">
	<label style="font-size: 18px; color: white; font-weight: normal;">历史操盘记录：
</label>
<div style="display: none;" id="userId"><shiro:principal property="id" /></div>
	

<select name="recording" id="recordSet" class="select_searchable"
	style="border-color: #1addfa; width: 180px; height: 30px; color: white; background-color: #00063c;border-radius: 16px;">
<option value="">重选更新记录</option>
<%-- <option>${brand}</option>	
   <option>苹果</option>
   <option>华为</option>	
   <option>三星</option>	
...
<div class="col-xs-6">
	<button id="customizationModalShow" class="select"
		style="width: 129.61px; background-color: #00688B; height: 30px; border-radius: 16px; margin-left: 700px;"
href="" ; onclick="setCoding()">保存操盘所选</button>
...
</label> <select name="term_brnd_nam" id="select1"
...
</label> <select name="kind" id="kind" onchange="kindes()" runat="server"
	style="border-color: #1addfa; width: 100px; height: 30px; color: white; border-radius: 16px; background-color: #00063c;">
...
<div class="col-xs-3">
	<label style="font-size: 18px; color: white; font-weight: normal;">&nbsp;&nbsp;&nbsp;竞&nbsp;&nbsp;&nbsp;品：
</label> <select name="COMPETBRANDNAME1" id="COMPETBRANDNAME1"
	class="select_searchableMy" runat="server"
	style="border-color: #1addfa; width: 100px; color: white; background-color: #00063c; height: 30px;border-radius: 16px;">
	<option value="">请选择竞品</option>
</select> 
<select name="COMPETSPEC1" id="COMPETSPEC1"
	class="select_searchableMy" runat="server"
	style="border-color: #1addfa; width: 100px; color: white; background-color: #00063c; height: 30px;border-radius: 16px;">
...
<label style="font-size: 18px; color: white; font-weight: normal;">&nbsp;&nbsp;&nbsp;日指标:
</label> <input name="day1" id="day1" runat="server" type="text"
	style="width: 21%; height: 30px; background-color: #00063c; border-color: #1addfa; color: white; border-radius: 16px;"
readonly="readonly"
onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-{%M}',onpicked:selectDate})" />


<label style="font-size: 18px; color: white; font-weight: normal;">&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
</label> <input name="day2" id="day2" runat="server" type="text"
	style="width: 21%; height: 30px; background-color: #00063c; border-color: #1addfa; color: white; border-radius: 16px;"
readonly="readonly"
onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-{%M}',onpicked:selectDate})" />
</div>
<div class="col-xs-3" id="mon" style="display: none">
	<label style="font-size: 18px; color: white; font-weight: normal;">&nbsp;&nbsp;&nbsp;月指标:
</label> <input name="month1" id="month1" runat="server" readonly="readonly"
	type="text"
	style="width: 20%; height: 30px; background-color: #00063c; border-color: #1addfa; color: white; border-radius: 16px;"
onClick="WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-{%M}',onpicked:selectDate})" />

<label font-size: 18px; color: white; font-weight:normal;">&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</label> <input name="month2" id="month2" runat="server" type="text"
	style="width: 20%; height: 30px; background-color: #00063c; border-color: #1addfa; color: white; border-radius: 16px;"
readonly="readonly"
onClick="WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-{%M}',onpicked:selectDate})" />
</div>
<div class="col-xs-2">
	...
	<button id="customizationModalShow" class="select" name="btName"
		style="width: 55%; height: 30px; background-color: #00688B; border-radius: 16px; margin-left: 5%;"
onclick="btn()">查询</button>
...
</label> <select name="term_mdl_nam" id="select2" class="select_searchableMy"
	runat="server"
	style="border-color: #1addfa; width: 100px; color: white; background-color: #00063c; height: 30px;border-radius: 16px;">
...
<div class="col-xs-3">
	...
	<label style="font-size: 18px; color: white; font-weight: normal;">&nbsp;&nbsp;&nbsp;对标品：
</label> <select name="COMPETBRANDNAME2" id="COMPETBRANDNAME2"
	class="select_searchableMy" runat="server"
	style="border-color: #1addfa; width: 100px; color: white; background-color: #00063c; height: 30px;border-radius: 16px;">
	<option value="">请选择竞品</option>
</select> <select name="COMPETSPEC2" id="COMPETSPEC2"
	class="select_searchableMy" runat="server"
	style="border-color: #1addfa; width: 100px; color: white; background-color: #00063c; height: 30px;border-radius: 16px;">
		<option value="">请选择型号</option>
	</select>
...
<select name="changed" id="changeModel" runat="server"
	style="border-color: #1addfa; width: 120px; color: white; background-color: #00063c; height: 30px; border-radius: 16px;">
<!-- <option value="">请选择对比类型</option> -->
		<option>相对类型</option>
		<option selected="selected">绝对类型</option>
	</select>
...
进入全生命周期</button> -->
<button id="customizationModalShow" class="select"
	style="width: 55%; background-color: #00688B; height: 30px; border-radius: 16px; margin-left: 5%;"
href="" ; onclick="btn1()">进入全生命周期</button>
...
<!-- 显示总销量，总覆盖店铺等总量的显示框-->
 ...
 <div class='col-xs-3'> 
		<div class='panel panel-default' style='width: 80%;margin-left:30px;'> 
			<div class='panel-body' >
	 			<p style="margin:0px;text-align: center;color:#33ffff"><font size="6">总销量值</font></p>
	 			
				<h1  style='margin:0px;text-align: center;' id="zwtcyhs">&nbsp;</h1>
			</div>
		</div>
	</div>
	<div class='col-xs-3'> 
		<div class='panel panel-default' style='width: 80%;margin-left:10px;'> 
			<div class='panel-body' >
	 			<p style="margin:0px;text-align: center;color:#33ffff"><font size="6">总收入值</font></p>
				
				<h1  style='margin:0px;text-align: center;' id="zsrz">&nbsp;</h1>
			</div>
		</div>
	</div>
	<div class='col-xs-3'> 
		<div class='panel panel-default' style='width: 80%;margin-left:-10px;'> 
			<div class='panel-body' >
	 			<p style="margin:0px;text-align: center;color:#33ffff"><font size="6">总覆盖客户值</font></p>
				
				<h1  style='margin:0px;text-align: center;' id="zfgz">&nbsp;</h1>
			</div>
		</div>
	</div>
	<div class='col-xs-3'> 
		<div class='panel panel-default' style='width: 80%;margin-left:-40px;'> 
			<div class='panel-body' >
	 			<p style="margin:0px;text-align: center;color:#33ffff"><font size="6">总覆盖网店值</font></p>
	 			
				<h1  style='margin:0px;text-align: center;' id="zfgwdz">&nbsp;</h1>
			</div>
		</div>
	</div>		
 </div>
...
<div class="col-xs-12" style="margin-top:50px;">
	<div id="backHome"
		style="color: #1addfa; font-size: 20px; display: none;">页面正在加载，请稍后····</div>
...
<div class="row" style="margin: 20px; z-index: 1000;margin-top: -180px;">

<div class="col-xs-1">
	<button id="bt1" class="selectStyle" onclick="saleProduct()"
style="width: 140%; background-color: #00688B; border-radius: 16px; margin-top: 10%">销量
	</button>
</div>

<div class="col-xs-1">
	<button id="bt2" class="selectStyle" onclick="priceProduct()"
style="width: 140%; margin-left: 50%; background-color: #00688B; border-radius: 16px; margin-top: 10%">价格
	</button>
</div>
...
style="width: 140%; margin-left: -10%; background-color: #00688B; border-radius: 16px; margin-top: 10%">收入
	</button>
</div>

<div class="col-xs-1">
	<button id="bt4" class="selectStyle" onclick="stock()"
style="width: 140%; margin-left: 40%; background-color: #00688B; border-radius: 16px; margin-top: 10%">库存
	</button>
</div>
...
style="width: 140%; margin-left: 90%; background-color: #00688B; border-radius: 16px; margin-top: 10%">
		价差</button>
</div>
...
style="width: 140%; margin-left: 30%; background-color: #00688B; border-radius: 16px; margin-top: 10%">份额
	</button>
</div>

<div class="col-xs-1">
	<button id="bt7" class="selectStyle" onclick="cover()"
style="width: 140%; margin-left: 80%; background-color: #00688B; border-radius: 16px; margin-top: 10%">覆盖
	</button>
</div>

<div class="col-xs-1">
	<button id="bt8" class="selectStyle" onclick="order()"
style="width: 140%; margin-left: 130%; background-color: #00688B; border-radius: 16px; margin-top: 10%">秩序
		</button>
	</div>
...
<div class="col-xs-6">
	<div id="container8"
		style="height: 338px; user-select: none; -webkit-tap-highlight-color: #1addfa; margin-top: 10%">
	</div>
</div>
...
<div class="col-xs-6">
	<div id="container"
		style="border-style: outset; border-color: #00FF00; height: 338px; user-select: none; -webkit-tap-highlight-color: #1addfa;">
	</div>
</div>

<div class="col-xs-6" style="">
<div id="container1"
	style="height: 338px; user-select: none; -webkit-tap-highlight-color: #1addfa; border-style: outset; border-color: #00FF00;">
		</div>
	</div>
...
window.onload = function() {
 ...
 $("#day2").val('2019-10-30');
	...
	var a = {};
	var line="1";
	//执行查询汇总销量，收入，覆盖网店值等数据
	$.ajax({
				
		        
		        url : "../absolute1/sumTotal.do",
				type : "post",
				async : false,
				cache : false,
				dataType : "json",
				...
				success : function(data) {
					//zsrz,zfgz,zfgwdz
					$("#zwtcyhs").html(data.amount+"台");
					$("#zsrz").html(data.amountprice+"元");
					$("#zfgz").html(data.salecostprice+"个");
					$("#zfgwdz").html(data.saleprice+"个");
				}
			});
	...
	$.ajax({
		...
		success : function(data) {
			if (!isEmptyObject(data)) {
				var str=day1.substring(0, 4)+"销量";				
				var pre=day1.substring(0, 4);
                var next=pre-1;
				var str1=next+"销量";
				 var title = [ str1, str ];
				text = '销量趋势',
	...
	$.ajax({
		...
		success : function(data) {
			if (!isEmptyObject(data)) {
				text = '五线七口销量', title = '', getPaint9("container8",
						text, title, data);
...
<script type="text/javascript">
		...
		function getOption() {
			option = {
...

				{
					...
					stack : '总量',
					data : []
				// [ 220, 182, 191, 234, 290, 330, 310, 182, 191, 234 ]
				}, {
					//name : '规划销量',
					smooth : true,
					color : '#00EE00',
					...
					stack : '总量',
					data : []
				//[ 150, 232, 201, 154, 190, 330, 410, 182, 191, 234 ]
				}, {
					//name : '对标品销量',
					smooth : true,
					color : 'yellow',
					...
					stack : '总量',
					data : []
				//[ 320, 332, 301, 334, 390, 330, 320, 182, 191, 234 ]
				}, {
					//name : '竞品销量',
					smooth : true,
					color : 'blue',
					...
					stack : '总量',
					data : []
				//[ 820, 932, 901, 934, 1290, 1330, 1320, 182, 191, 234 ]
				} ]
			};
			return option;
		...
		function getPaint10(container10, text, title, mapData) {
			...
			option.xAxis[1].data = mapData[1];//2018
			option.series[0].name = title[0];//2018
			option.series[1].name = title[1];//2017
			option.series[0].data = mapData[3];//2017
				...
				$.ajax({
					...
					success : function(data) {
						for (var i = 0; i < data.length; i++) {
							...
							$("#COMPETBRANDNAME1").append(
									"<option value='"+data[i]+"'>" + data[i]
											+ "</option>");
							$("#COMPETBRANDNAME2").append(
									"<option value='"+data[i]+"'>" + data[i]
											+ "</option>");
		...
		function changeTime() {
			//var timed = $("#times").val();
			var timed = $("#times option:selected").text()
			if (timed == '日指标') {
				$("#dayes").show();
				$("#mon").hide();
		...
		function btn() {
			$("#backHome").show();
			var changeModel = $("#changeModel option:selected").text();//品牌对比类型   harry1为相对类型  ，harry2为绝对类型
			var timed = $("#times option:selected").text();//时间类型				
			...
			$.ajax({
					...
					$.ajax({
						...
						data : {
							...
							'BRANDNAME' : brand,
							'SPEC' : model,
							'brand1' : COMPETBRANDNAME1,
							'model1' : COMPETSPEC1,
							'brand2' : COMPETBRANDNAME2,
							'model2' : COMPETSPEC2,
							'number' : number
						},
						success : function(data) {
							if (!isEmptyObject(data)) {
								...
								var str1=next+"销量";
								 var title = [ str1, str ];
								text = '销量趋势', getPaint10("container10", text,
										title, data);
					...
					$.ajax({
						...
						success : function(data) {
							if (!isEmptyObject(data)) {
								text = '五线七口销量', title = '', getPaint9(
										"container8", text, title, data);
							...
							.ajax({
								...
								success : function(data) {
									if (!isEmptyObject(data)) {
										...
										var title = [ '当前销量', '规划销量', '竞品销量',
												'对标品销量' ];

										text = '量 :  当前销量、规划销量、对标品销量与竞品销量对比曲线（台）                                                                                ';
										getPaint1("container", text, title,
												data);
							...
							.ajax({
								...
								success : function(data) {
									if (!isEmptyObject(data)) {
										...
										var title = [ '本品价格', '本品二级市场价格',
												'竞品二级市场价格' ];
										text = '价 :  本品价格及本品竞品二级市场价格(元)                                                                               ';
										getPaint2("container1", text, title,
												data);
					...
					$
							.ajax({
								...
								success : function(data) {
									if (!isEmptyObject(data)) {
										var title = [ '当前收入', '规划收入', '对标品收入',
												'竞品收入' ];
										text = '收  : 当前收入、规划收入、对标品收入与竞品收入对比曲线（元）                                                                                        ';
										getPaint3("container2", text, title,
												data);
							...
							.ajax({
								...
								success : function(data) {
									if (!isEmptyObject(data)) {
										...
										var title = [ '当前毛利', '规划毛利', '对标品毛利',
												'竞品毛利' ];
												text = '利  : 当前毛利、规划毛利、对标品毛利与竞品毛利对比曲线（万元）                                                                   ',
												getPaint5("container4", text,
														title, data);
							...
							.ajax({
								...
								success : function(data) {
									if (!isEmptyObject(data)) {
										...
										var title = [ 'DM本地激活数', 'DM异地激活数',
												'疑似套机数' ];
												text = '秩 : DM本地激活数、DM异地激活数与疑似套机数                                                                               ',

												getPaint8("container7", text,
														title, data);
				...
				if (timed == '日指标') {
					...
					$
							.ajax({
								...
								success : function(data) {
									if (!isEmptyObject(data)) {
										document.getElementById("container5").style.display = "";
										var title = [ '当前份额' ];
												text = '份  : 当前份额对比曲线                                                                                                                                                            ',
												getPaint6("container5", text,
														title, data);
					...
					$
							.ajax({
								...
								success : function(data) {
									if (!isEmptyObject(data)) {
										document.getElementById("container6").style.display = "";
										var title = [ '累计覆盖客户数' ];
												text = '覆 : 覆盖客户数曲线(个)                                                                                                             ',
					...
					$
							.ajax({
								...
								success : function(data) {
									if (!isEmptyObject(data)) {
										document.getElementById("container7").style.display = "";
										var title = [ 'DM本地激活数', 'DM异地激活数',
												'疑似套机数' ];
												text = '秩 : DM本地激活数、DM异地激活数与疑似套机数                                                                               ',
		...
		function btn1() {
			...
			$.StandardPost(basePath + '/quantitySet/show.do', {
				'BRANDNAME' : brand,
				'SPEC' : model,
				'brand1' : COMPETBRANDNAME1,
				'model1' : COMPETSPEC1,
		...
		function saleProduct() {
			...
			var kind = $("#kind").val(); //竞品类型
			var timed = $("#times option:selected").text();//时间类型//时间类型		
			var brand = $("#select1").val();
			var model = $("#select2").val();
			var day1 = $("#day1").val();
			var day2 = $("#day2").val();
...
$.ajax({
			url : "../absolute/recordBrandSet.do",
			type : "post",
			async : false,
			cache : false,
			dataType : "json",
...
if (result[0].timeKind == "月指标") {
			$("#dayes").hide();
			$("#mon").show();												
document.getElementById("month1").value = result[0].startTime;
document.getElementById("month2").value = result[0].endTime;
var xxfbqd=result[0].brand;//后台取回的数据,
optionValue($("#select1"),xxfbqd);//$("#xxfbqd")为select的id
document.getElementById("select2").innerHTML = "<option>"+ result[0].spec+ "</option>";
document.getElementById("select1").innerHTML = "<option>"+ result[0].brand+ "</option>";
var brandCompation=result[0].brandCompation;
optionValue($("#COMPETBRANDNAME1"),brandCompation);
document.getElementById("COMPETSPEC1").innerHTML = "<option>"+ result[0].specCompation+ "</option>";
var brandContrast=result[0].brandContrast;
optionValue($("#COMPETBRANDNAME2"),brandContrast);
document.getElementById("COMPETSPEC2").innerHTML = "<option>"+ result[0].specContrast+ "</option>";													
	//var timed=result[0].timeKind;//后台取回的数据,
	//optionValue($("#times"),timed);//$("#xxfbqd")为select的id
	var changeModels=result[0].contrastKind;//对比类型
	optionValue($("#changeModel"),changeModels);//$("#xxfbqd")为select的id	
	var kindes=result[0].brandKind;//品牌种类
	optionValue($("#kind"),kindes);//$("#xxfbqd")为select的id
	//document.getElementById("times").innerHTML = "<option>"+ result[0].timeKind+ "</option>";//
	var timed=result[0].timeKind;//时间种类
    optionValue($("#times"),timed);//$("#xxfbqd")为select的id
}
...
if (result[0].timeKind == "日指标") {
	//var time=result[0].timeKind;

	$("#dayes").show();
	$("#mon").hide();

document.getElementById("day1").value = result[0].startTime;
document.getElementById("day2").value = result[0].endTime;
...
var changeModels=result[0].contrastKind;//后台取回的数据,
optionValue($("#changeModel"),changeModels);//$("#xxfbqd")为select的id

var kindes=result[0].brandKind;//后台取回的数据,
optionValue($("#kind"),kindes);//$("#xxfbqd")为select的id
...
function optionValue1(id,value){
var numbers = id.find("option"); //获取select下拉框的所有值
for (var j = 1; j < numbers.length; j++) {
if($(numbers[j]).innerText == "日指标"){
	
	$(numbers[j]).attr("selected", "selected");
	
}else if ($(numbers[j]).innerText == "月指标"){
	$(numbers[j]).attr("selected", "selected");
	
	
}
/* if($(numbers[j]).val() == 'day'){
	
	$(numbers[j]).attr("selected", "selected");
	
}
      if($(numbers[j]).val() == 'harry1'){
	
	$(numbers[j]).attr("selected", "selected");
	
}
         if($(numbers[j]).val() == 'harry2'){
