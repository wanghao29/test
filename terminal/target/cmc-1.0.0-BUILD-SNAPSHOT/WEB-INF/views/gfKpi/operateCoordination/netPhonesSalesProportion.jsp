...
<title>网内战略型手机销量占比</title>
</head>

<body>
 
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/operateCoordination/netPhonesSalesProportion.js"></script>
<script type="text/javascript" src="<%=basePath%>resources/js/plugin/jquery.validate.js"></script>
	...
	.ui-jqgrid .ui-common-table {
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="网内战略型手机销量占比_19"/><!-- 标记所属的指标 -->
	     <input type="hidden" id="billcyc"  value="${billcyc}"/>
	<div class="row">
		<ol class="breadcrumb">
		 <li>经分监控</li>
		  <li>基础项</li>
		  <li class=" ">网内战略型手机销量占比</li>
		</ol>
	</div>
		  ...
		  <div class="panel panel-default" style=" width: 100%;">
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				    ...
				    <div class="col-xs-4" style="float:right;">
				    	...
				    	<input type="hidden" id="hid_kpikey" value="netPhonesSalesProportion"/><!-- 和权限有关  慎改 -->
				    </div>
					      ...
					      <div class="col-xs-4">
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">网内战略型手机销量占比</span>
								   	  <span id="wnzlxsjxlzb" style="margin-left: 100px; font-size: 50px;"> </span>  
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  <span style="font-size: 20px;">基本目标值</span>
										  <span id="jsmbz" style="margin-left: 100px; font-size: 50px;"> </span>
								  </div>
							  </div>
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">基本得分</span>
								   	 <span id="df" style="margin-left: 100px; font-size: 50px;">   </span>
								   	 <span style="font-size: 20px;">亿</span>
								  </div>
							  </div>
				    ...
				    <div class="row">
					            ...
					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins  " id="jsmbz" > </h1>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				<form id="addForm" class="form-horizontal" role="form">
				  ...
				  <div class="form-group">
				    <label for="lastname" class="col-sm-4 control-label">网内战略型手机销量占比</label>
				    <div class="col-sm-4">
				      <input type="text" class="form-control" id="wnzlxsjxlzbInput" name="wnzlxsjxlzbInput" placeholder="请输入网内战略型手机销量占比">
				    </div>
				     <label style="margin-top: 10px;">%</label>
				  </div>
				  <div class="form-group">
				    <label for="firstname" class="col-sm-4 control-label">基本目标值</label>
				    <div class="col-sm-4">
				      <input type="text" class="form-control" id="jbmbz" id="jbmbz" placeholder="请输入基本目标值">
				    </div>
				     <label style="margin-top: 10px;">%</label>
				  </div>
   				  <div class="form-group">
 				 ...
 				 <div class="form-group">
				    <label for="firstname" class="col-sm-4 control-label">内部支撑满意度得分</label>
				    <div class="col-sm-4">
				      <input type="text" class="form-control" id="nbzsmyddf" name ="nbzsmyddf" placeholder="请输入激励目标值"> 
				    </div>
				      <label style="margin-top: 10px;"></label>
				  </div>
				</form>
