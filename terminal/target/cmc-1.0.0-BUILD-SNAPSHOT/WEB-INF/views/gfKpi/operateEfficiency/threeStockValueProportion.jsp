...
<title>三个月以上存货原值占比</title>
</head>

<body>
 
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/operateEfficiency/threeStockValueProportion.js"></script>
	<style type="text/css">
	table tr td{
	  margin-right: 10px;
	}
...
small {
   ...
   padding-top:2px;
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="三个月以上存货原值占比_19"/><!-- 标记所属的指标 -->
	     <input type="hidden" id="billcyc"  value="${billcyc}"/>
	<div class="row">
		<ol class="breadcrumb">
		 <li>经分监控</li>
		  <li>基础项</li>
		  <li class=" ">三个月以上存货原值占比</li>
		</ol>
	</div>
		  ...
		  <div class="panel panel-default" style=" width: 100%;">
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				    ...
				    <div class="col-xs-4" style="float:right;">
				    	...
				    	<input type="hidden" id="hid_kpikey" value="threeStockValueProportion"/><!-- 和权限有关  慎改 -->
				    </div>
				    ...
				    <div class="row">
					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins" id="amount_90_180_df" > </h1>
					                    <!--     <div class="stat-percent font-bold text-navy">20% <i class="fa fa-level-up"></i>
					                        </div> -->
					                        <small>90-180天得分</small>
					                    </div>
					                </div>
					            </div>
					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins  " id="amount_180_360_df" > </h1>
					                      <!--   <div class="stat-percent font-bold text-info">40% <i class="fa fa-level-up"></i>
					                        </div> -->
					                        <small>180-360得分</small>
					                    </div>
					                </div>
					            </div>
					            <div class="col-lg-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins   " id="amount_360_df" > </h1>
					                       <!--  <div class="stat-percent font-bold text-warning">16% <i class="fa fa-level-up"></i>
					                        </div> -->
					                        <small>360天得分</small>
					                    </div>
	...
	<!-- 			    <div class="row">
					      <div class="col-xs-4">
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">90-180天占比</span>
								   	  <span id="ratio_amount_90_180" style="margin-left: 100px; font-size: 40px;"> </span>  
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  <span style="font-size: 20px;">180-360占比</span>
										  <span id="ratio_amount_180_360" style="margin-left: 100px; font-size: 55px;"> </span>
								  </div>
							  </div>
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">360天占比</span>
								   	 <span id="ratio_amount_360" style="margin-left: 100px; font-size: 55px;">   </span>
								   	 <span style="font-size: 20px;">亿</span>
								  </div>
							  </div>
				     ...
				     <div class="row">
					      <div class="col-xs-4">
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">90-180天得分</span>
								   	  <span id="amount_90_180_df" style="margin-left: 100px; font-size: 40px;"> </span>  
								   	   <span style="font-size: 20px;">亿</span>
								  </div>
							  </div>
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  <span style="font-size: 20px;">180-360得分</span>
										  <span id="amount_180_360_df" style="margin-left: 100px; font-size: 55px;"> </span>
								  </div>
							  </div>
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">360天得分</span>
								   	 <span id="amount_360_df" style="margin-left: 100px; font-size: 55px;">   </span>
								   	 <span style="font-size: 20px;">亿</span>
								  </div>
							  </div>
