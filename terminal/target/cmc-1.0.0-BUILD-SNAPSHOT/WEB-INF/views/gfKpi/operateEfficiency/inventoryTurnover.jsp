...
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/operateEfficiency/inventoryTurnover.js"></script>
	<style type="text/css">
	table tr td{
	  margin-right: 10px;
	}
	...
	.ui-jqgrid .ui-common-table {
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="存货周转率_19"/><!-- 标记所属的指标 -->
		  ...
		  <div class="panel panel-default" style=" width: 100%;">
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				    ...
				    <div class="col-xs-4" style="float:right;">
				    	...
				    	<input type="hidden" id="hid_kpikey" value="inventoryTurnover"/><!-- 和权限有关  慎改 -->
				    </div>
					            ...
					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins" id="chzzl" > </h1>
					      ...
					      <div class="col-xs-4">
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">存货周转率</span>
								   	  <span id="chzzl" style="margin-left: 100px; font-size: 40px;"> </span>  
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  <span style="font-size: 20px;">目标次数</span>
										  <span id="mbz" style="margin-left: 100px; font-size: 55px;"> </span>
								  </div>
							  </div>
