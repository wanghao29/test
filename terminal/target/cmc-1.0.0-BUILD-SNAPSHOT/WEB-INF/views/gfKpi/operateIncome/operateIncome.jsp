...
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/operateIncome/operateIncome.js"></script>
	<style type="text/css">
	table tr td{
	  margin-right: 10px;
	}
    ...
    font-size: 200%;
     color: white;
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="运营收入_19"/><!-- 标记所属的指标 -->
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				      <div class="col-xs-8">
						 ...
						 <div class="col-xs-4" style="float:right;">
				    		...
				    		<input type="hidden" id="hid_kpikey" value="operateIncome"/><!-- 和权限有关  慎改 -->
				    	</div>
				    </div>
					      ...
					      <div class="col-xs-4">
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <h1 style="font-size: 20px;">全年完成收入</h1>
								   	  <span id="hQnwcsr" style="margin-left: 100px; font-size: 50px;"> </span>  
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  <span style="font-size: 20px;">全年完成度</span>
										  <span id="hQnwcd" style="margin-left: 100px; font-size: 50px;"> </span>
								  </div>
							  </div>
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">时间完成度</span>
								   	 <span id="sjwcd" style="margin-left: 100px; font-size: 50px;">   </span>
								   	 <span style="font-size: 20px;">亿</span>
								  </div>
							  </div>
					            ...
					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins" id="hQnwcsr" > </h1>
...
<!-- 					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins  " id="hQnwcd" > </h1>
					            ...
					            <div class="col-lg-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins   " id="sjwcd" > </h1>
