...
<title>单位人工费用创利比</title>
</head>

<body>
 
<script type="text/javascript" src="<%=basePath%>resources/js/gfKpi/operateBenefit/unitCostProfit.js"></script>
	<style type="text/css">
	table tr td{
	  margin-right: 10px;
	}
	...
	.ui-jqgrid .ui-common-table {
	    ...
	    <input type="hidden" id="select_yf" /><!-- 选中行的月份 -->
	     <input type="hidden" id="flag"  value="单位人工费用创利比_19"/><!-- 标记所属的指标 -->
	     <input type="hidden" id="billcyc"  value="${billcyc}"/>
	<div class="row">
		<ol class="breadcrumb">
		 <li>经分监控</li>
		  <li>基础项</li>
		  <li class=" ">单位人工费用创利比</li>
		</ol>
	</div>
		  ...
		  <div class="panel panel-default" style=" width: 100%;">
				  ...
				  <div class="row"  style="margin-bottom: 10px;" >
				    ...
				    <div class="col-xs-4" style="float:right;">
				    	...
				    	<input type="hidden" id="hid_kpikey" value="unitCostProfit"/><!-- 和权限有关  慎改 -->
				    </div>
					      ...
					      <div class="col-xs-4">
					         <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
									  <span style="font-size: 20px;">利润总额</span>
								   	  <span id="lrze" style="margin-left: 100px; font-size: 40px;"> </span>  
					  	 ...
					  	 <div class="col-xs-4">
					  	     <div class="panel panel-default" style=" width: 100%;">
								  <div class="panel-body" style="display: flex;align-items:center;justify-content: center;">
										  <span style="font-size: 20px;">单位人工费用创利比</span>
										  <span id="dwrgfyclb" style="margin-left: 100px; font-size: 55px;"> </span>
								  </div>
							  </div>
					            ...
					            <div class="col-sm-4">
					                <div class="ibox float-e-margins">
					                    ...
					                    <div class="ibox-content">
					                        <h1 class="no-margins" id="lrze" > </h1>
