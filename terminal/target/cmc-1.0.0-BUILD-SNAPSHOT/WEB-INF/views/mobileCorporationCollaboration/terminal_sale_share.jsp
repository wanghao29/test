...
<head>
    ...
    <title>省移动终端销量份额</title>

</head>
<body>
<script type="text/javascript" src="<%=basePath%>resources/js/mobileCorporationCollaboration/terminal_sale_share.js"></script>
...
<div class="row">
    <div class="panel panel-default" style=" width: 100%;">
        <div class="panel-body" >
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="panel panel-default" style=" width: 100%;">
                        <div class="panel-body" >
                            <p>销量占比</p>
                            <h1 id="hXlzb" style="float: right;">4.19  </h1>
                        </div>
                    </div>
			...
			<input type="hidden" id="flag"  value="省移动终端销量份额"/><!-- 标记所属的指标 -->  
