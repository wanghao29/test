...
<title>总支出占综合毛利比</title>

</head>
<body>
<script type="text/javascript" src="<%=basePath%>resources/js/totalprofit/gross_profit_ratio.js"></script>
...
<div class="row">
  <div class="panel panel-default" style=" width: 100%;">
	  ...
	  <div class="row"  style="margin-bottom: 10px;" >
	    ...
	    <div class="row">
		      <div class="col-xs-2">
		         <div class="panel panel-default" style=" width: 100%;">
					  <div class="panel-body" >
					     <p>考核支出</p>
					   	 <h1 id="hKhzc" style="float: right;">  </h1>
					  </div>
				  </div>
		...
		<input type="hidden" id="flag"  value="总支出占综合毛利比"/><!-- 标记所属的指标 -->  
