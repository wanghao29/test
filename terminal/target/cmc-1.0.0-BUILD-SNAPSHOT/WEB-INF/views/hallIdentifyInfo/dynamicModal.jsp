...
$(document).ready(function() {
    ...
    $("#all_field_dynamic input:checkbox").change(function(){
    	...
    	$("#list_dynamic").setGridWidth(len_dynamic);
    	setGroupHeaders();
    });
...
function quanxuan(type_all,type){
	$("."+type_all).click(function(){
    	...
    	$("#"+jqgridId).setGridWidth(len_dynamic);
    	setGroupHeaders();
	});
}
...
function jqgridInit_dynamic(){
	  jQuery("#list_dynamic").jqGrid({
	        url:"${basePath}hallIdentifyInfo/listHallDynamic.do",
	        mtype:'post',
	        datatype: "json",
	        loadonce:true,     //一次性加载
	  ...
	  len_dynamic=$("#list_dynamic").getGridParam("width");  
	  setGroupHeaders();
};
