...
<body>
<script type="text/javascript" src="<%=basePath%>resources/js/businessIncome/income_multi_form.js"></script>
...
<!-- <div class="col-xs-12">
      <h2   style="color:#33FFFF;"><strong>自有品牌多形态终端收入</strong></h2>
</div> -->

<div class="row">
<ol class="breadcrumb">
  <li><a href="#">基础项</a></li>
  <li class="active">自有品牌多形态终端收入</li>
...
<div class="row">
    <div class="panel panel-default" style=" width: 100%;">
        <div class="panel-body" >
			...
			<input type="hidden" id="flag"  value="自有品牌多形态终端收入"/><!-- 标记所属的指标 -->  
