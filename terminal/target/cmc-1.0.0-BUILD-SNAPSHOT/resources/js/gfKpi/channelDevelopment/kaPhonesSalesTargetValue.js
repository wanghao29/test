...
function jqgridInit(){
	  jQuery("#grid").jqGrid(
	      {
	        url:basePath+"/kaPhonesSalesTargetValue/queryData.do",
	        mtype:'post',
	        datatype: "json",
	        ...
	        //scroll:1, 滚动加载
	        //datatype : "local",
	        colNames : [ '月份','KA客户销量','KA客户全年销量','目标值','时间完成度','完全情况占比','得分' ],
	        colModel : [ 
	           {name : 'billcyc',index : 'billcyc' }, 
			   {name : 'kakhxl',index : 'kakhxl', formatter: "number", formatoptions: {thousandsSeparator:",", defaulValue:"",decimalPlaces:2}  }, 
