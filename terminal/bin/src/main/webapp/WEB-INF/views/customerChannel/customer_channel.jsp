      		...
      		<div class="row top-select">
		            ...
		            <div class="col-xs-2" style="margin-left:1%;">
				        <div class="input-group">
				            ...
				            <input type="text" name="custnameInput" class="form-control">		            
				        </div>	
				    </div>
		            <div class="col-xs-2" style="margin-left:1%;">
				        <div class="input-group">
				        	<span class="input-group-addon">(搜索)客商编码</span>
				            <input type="text" name="cusOrgacodeInput" class="form-control">		            
				        </div>	
				    </div>	
...
function jqgridInit(data){
	  ...
	  function choose_cust(cellValue, options, rowdata, action){  //rowdata.orgacode
		    return "<a href='#' onclick=\"choosedCust('"+rowdata.month+"','"+rowdata.tag1+"','"+rowdata.cusOrgacode+"')\" style='color:yellow;'>选择</a>";
	  };
};

function choosedCust(month, tag1, cusOrgacode){
