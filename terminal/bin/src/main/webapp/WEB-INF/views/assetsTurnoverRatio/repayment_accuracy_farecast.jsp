...
<body>
<script type="text/javascript" src="<%=basePath%>resources/js/assetsTurnoverRatio/repayment_accuracy_forecast.js"></script>
			          ...
			          <td > 结束时间:</td>
			      	  <td> <input name="endMonth" type="text" style="width:130px" onClick="WdatePicker({dateFmt:'yyyyMM',maxDate:'%y-%M'})" readonly="readonly"class="form-text select"/></td>
			      	   ...
			      	   <td >  <button id="btnSearch" type="button" class="btn btn-primary" style="width:100px">查询</button> </td>
			      	    <td >  <button id="addItem" type="button" class="btn btn-primary" style="width:100px">新增</button> </td>
	    ...
	    <div class="row">
		      <div class="col-xs-6">
		         <div class="panel panel-default" style=" width: 100%;">
					  <div class="panel-body" >
					     <p>回款预测准确度</p>
					   	 <h1 id="hHkyczqd" style="float: right;">4.19  </h1>
					  </div>
				  </div>
...
<!-- 		  <div id="toolbar">
		...
		<input type="hidden" id="flag"  value="回款预测准确度"/><!-- 标记所属的指标 --> 
	  </div>
 </div>
