 ...
 <label style="background-color: #00063c;font-size: 18px;"> 关注维度：</label>  
   ...
   <input id="spec2" type="hidden" value="${map.COMPETSPEC2}">
    <select id="select1" style="background-color: #00063c;font-size: 18px;">
        ...
        <option>量</option>
        <option>利</option>
        <option selected="selected">收</option>
        <option>价</option>
        <option>覆</option>
        <option>库</option>
        <option>份</option>
   ...
   <a download="收数据导出Excel" id="excelOut" class="bt5" href="#" style="height: 50px;">导出Excel</a>
   </div>
   </div>
...
<table border="1" bordercolor="#1addfa" id="table5">
			...
			<tr  bgcolor="#4682B4">
			<td colspan="18" align="center" height="40px;"style="font-size: 25px;">产品信息操盘收实时数据</td>
			</tr>
			...
			<tr>
                ...
                <td colspan="2" align="center">当前收入</td>
                <td rowspan="2" align="center">对标品收入</td>
                <td rowspan="2" align="center">竞品收入</td>
