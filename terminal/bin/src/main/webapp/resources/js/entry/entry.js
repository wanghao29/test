    ...
    function getVal(){
        $.ajax({
            ...
            success: function(result,textStatus){
                ...
                //雷达图
                initEchart(result.businessIncomeFz,result.terminalSalesFZ,result.shqdtzFz,result.sgsxtFz,result.grossProfitRatioFZ);
                ...
                $('#businessIncome td:eq(3)').text((result.businessIncome.mbz/100000000).toFixed(2));
                $('#businessIncome td:eq(4)').text("亿元");
                $('#businessIncome td:eq(5)').text((result.businessIncome.bywcqk/100000000).toFixed(6));
                $('#businessIncome td:eq(6)').text((result.businessIncome.qnwcsr/100000000).toFixed(6));
                $('#businessIncome td:eq(7)').text(result.businessIncome.sjwcd);
                }else{
                	$('#businessIncome td:eq(2)').text('-');
                    $('#businessIncome td:eq(3)').text('-');
                    $('#businessIncome td:eq(5)').text('-');
                ...
                $('#incomePhoneBrand td:eq(2)').text((result.incomePhoneBrand.mbz/10000).toFixed(2));
                $('#incomePhoneBrand td:eq(3)').text("万元");
                $('#incomePhoneBrand td:eq(4)').text((result.incomePhoneBrand.bywcqk/10000).toFixed(4));
                $('#incomePhoneBrand td:eq(5)').text((result.incomePhoneBrand.qnwcsr/10000).toFixed(4));
                $('#incomePhoneBrand td:eq(6)').text(result.incomePhoneBrand.sjwcd);
                }else{
                	$('#incomePhoneBrand td:eq(1)').text('0');
                    $('#incomePhoneBrand td:eq(2)').text('-');
                    $('#incomePhoneBrand td:eq(4)').text('-');
                ...
                $('#incomeMultiForm td:eq(2)').text((result.incomeMultiForm.mbz/10000).toFixed(2));
                $('#incomeMultiForm td:eq(3)').text("万元");
                $('#incomeMultiForm td:eq(4)').text((result.incomeMultiForm.bysrwcl/10000).toFixed(4));
                $('#incomeMultiForm td:eq(5)').text((result.incomeMultiForm.qnwcsr/10000).toFixed(4));
                $('#incomeMultiForm td:eq(6)').text(result.incomeMultiForm.sjwcd);
                }else{
                	 $('#incomeMultiForm td:eq(1)').text('0');
                     $('#incomeMultiForm td:eq(2)').text('-');
                     $('#incomeMultiForm td:eq(4)').text('-');
                ...
                $('#terminalSales td:eq(3)').text((result.terminalSales.mbz/10000).toFixed(2));
                $('#terminalSales td:eq(4)').text("万台");
                $('#terminalSales td:eq(5)').text((result.terminalSales.bykhxl/10000).toFixed(4));
                $('#terminalSales td:eq(6)').text((result.terminalSales.qnljxl/10000).toFixed(4));
                $('#terminalSales td:eq(7)').text(result.terminalSales.sjwcd);
                }else{
                	$('#terminalSales td:eq(2)').text('0');
                    $('#terminalSales td:eq(3)').text('-');
                    $('#terminalSales td:eq(5)').text('-');
                ...
                $('#productSalesRate td:eq(2)').text(result.productSalesRate.mbz);
...
//                $('#productSalesRate td:eq(6)').text(result.incomeMultiForm.sjwcd);
                    ...
                    $('#productSalesRate td:eq(2)').text('-');
                }
              //社会渠道拓展
                //活跃客户目标值
                if(result.customerTargetValue!=null){
                $('#customerTargetValue td:eq(2)').text(result.customerTargetValue.df);
                $('#customerTargetValue td:eq(3)').text(result.customerTargetValue.mbz);
                $('#customerTargetValue td:eq(4)').text("个");
                $('#customerTargetValue td:eq(5)').text(result.customerTargetValue.hyyhsl);
//                $('#customerTargetValue td:eq(6)').text(result.customerTargetValue.qnwcsr);
                $('#customerTargetValue td:eq(7)').text(result.customerTargetValue.sjjd);
                }else{
                	$('#customerTargetValue td:eq(2)').text('0');
                    $('#customerTargetValue td:eq(3)').text('-');
                    $('#customerTargetValue td:eq(5)').text('-');
//                    $('#customerTargetValue td:eq(6)').text('-');
                    $('#customerTargetValue td:eq(7)').text('-');
                }
                //KA客户销量目标值
                if(result.customerSaleTargetVal!=null){
                $('#customerSaleTargetVal td:eq(1)').text(result.customerSaleTargetVal.df);
                $('#customerSaleTargetVal td:eq(2)').text((result.customerSaleTargetVal.kakhxlmbz/10000).toFixed(2));
                $('#customerSaleTargetVal td:eq(3)').text("万台");
                $('#customerSaleTargetVal td:eq(4)').text((result.customerSaleTargetVal.kakhxs/10000).toFixed(4));
                $('#customerSaleTargetVal td:eq(5)').text((result.customerSaleTargetVal.kakhxslj/10000).toFixed(4));
                $('#customerSaleTargetVal td:eq(6)').text(result.customerSaleTargetVal.sjjd);
                }else{
                	 $('#customerSaleTargetVal td:eq(1)').text('0');
                     $('#customerSaleTargetVal td:eq(2)').text('-');
                     $('#customerSaleTargetVal td:eq(4)').text('-');
                ...
                $('#salesShare4G td:eq(2)').text(result.salesShare4G.gydf);
...
//                $('#terminalSaleShare td:eq(2)').text(result.terminalSaleShare.mbz);
                $('#terminalSaleShare td:eq(3)').text("万元");
                $('#terminalSaleShare td:eq(4)').text((result.terminalSaleShare.jhl/10000).toFixed(4));
...
//                $('#terminalSaleShare td:eq(6)').text(result.terminalSaleShare.sjwcd);
                       ...
                       $('#terminalSaleShare td:eq(2)').text('前五名满分');
                       $('#terminalSaleShare td:eq(4)').text('-');
...
//                $('#satisfaction td:eq(6)').text(result.satisfaction.sjwcd);
                    ...
                    $('#satisfaction td:eq(2)').text('-');
                    $('#satisfaction td:eq(4)').text('-');
                ...
                $('#stockTurnoverRatio td:eq(3)').text(result.stockTurnoverRatio.mbz);
                $('#stockTurnoverRatio td:eq(4)').text("次");
                $('#stockTurnoverRatio td:eq(5)').text(result.stockTurnoverRatio.chzzl);
                $('#stockTurnoverRatio td:eq(6)').text(result.stockTurnoverRatio.ljchzzl);
//                $('#stockTurnoverRatio td:eq(7)').text(result.stockTurnoverRatio.sjwcd);
                }else{
                	$('#stockTurnoverRatio td:eq(2)').text('0');
                    $('#stockTurnoverRatio td:eq(3)').text('-');
...
//                $('#threeMonthStockRatio td:eq(2)').text("90-180天小于2%&nbsp;180-360天&lt;0.5%&nbsp;360天以上小于0.");
                $('#threeMonthStockRatio td:eq(3)').text("比值");
                $('#threeMonthStockRatio td:eq(4)').text("90-180天="+result.threeMonthStockRatio.tsl90+"  180-360天="+result.threeMonthStockRatio.tsl180+"   360天以上="+result.threeMonthStockRatio.tsl360);
...
//                   $('#threeMonthStockRatio td:eq(2)').text("90-180天小于2%&nbsp;180-360天&lt;0.5%&nbsp;360天以上小于0.");
                   $('#threeMonthStockRatio td:eq(4)').text('-');
                }
                //回款预测准确度
...
//                $('#repaymentAccuracyForecast td:eq(2)').text(result.repaymentAccuracyForecast.mbz);
                $('#repaymentAccuracyForecast td:eq(3)').text("比值");
                $('#repaymentAccuracyForecast td:eq(4)').text(result.repaymentAccuracyForecast.hkyczqd);
...
//                   $('#repaymentAccuracyForecast td:eq(2)').text(result.repaymentAccuracyForecast.mbz);
                   $('#repaymentAccuracyForecast td:eq(4)').text('-');
                }
                //应收周转率
                ...
                $('#accountReceivableTurnoverRatio td:eq(2)').text(result.accountReceivableTurnoverRatio.mbz);
                $('#accountReceivableTurnoverRatio td:eq(3)').text("次");
                $('#accountReceivableTurnoverRatio td:eq(4)').text(result.accountReceivableTurnoverRatio.byyskzzl);
                $('#accountReceivableTurnoverRatio td:eq(5)').text(result.accountReceivableTurnoverRatio.ndyskzzl);
                $('#accountReceivableTurnoverRatio td:eq(6)').text('-');
                }else{
                         $('#accountReceivableTurnoverRatio td:eq(1)').text('0');
                         $('#accountReceivableTurnoverRatio td:eq(2)').text('-');
                         $('#accountReceivableTurnoverRatio td:eq(4)').text('-');
...
//                $('#accountsReceivableRatio td:eq(2)').text("90-180天=<5%；180天以上=<2%；");
                $('#accountsReceivableRatio td:eq(3)').text("比值");
                $('#accountsReceivableRatio td:eq(4)').text("90-180天="+result.accountsReceivableRatio.yszkzb90+"   180天以上="+result.accountsReceivableRatio.yszkzb180);
...
//                    $('#accountsReceivableRatio td:eq(2)').text('90-180天=<5%；180天以上=<2%；');
                    $('#accountsReceivableRatio td:eq(4)').text('-');
//                    $('#accountsReceivableRatio td:eq(5)').text(result.accountsReceivableRatio.qnwcsr);
                }
              //利润总额
                //总支出占综合毛利比
...
//                $('#grossProfitRatio td:eq(3)').text(result.grossProfitRatio.mbz);
                $('#grossProfitRatio td:eq(4)').text("比值");
                $('#grossProfitRatio td:eq(5)').text(result.grossProfitRatio.zzczzhmlb);
...
//                  $('#grossProfitRatio td:eq(3)').text(result.grossProfitRatio.mbz);
                  $('#grossProfitRatio td:eq(5)').text('-');
                }
                //费用进度均衡性
                if(result.equilibrium!=null){
//                $('#equilibrium td:eq(1)').text();
                $('#equilibrium td:eq(2)').text(result.feeProgressBalanceFZ);
                $('#equilibrium td:eq(3)').text("比值");
...
function initEchart(businessIncomeFz,terminalSalesFz,shqdtzFz,sgsxtFz,grossProfitRatioFz){
        ...
        series : [
            {
                ...
                data : [
                    ...
                    {
                        // value : [97, 42, 88, 94, 90, 86],
                        value : [businessIncomeFz,terminalSalesFz,Number(shqdtzFz).toFixed(2),sgsxtFz,grossProfitRatioFz],
                        label: {
                            normal: {
                                textStyle: {
                                    color:'#ffffff',
